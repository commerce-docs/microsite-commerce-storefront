  ...
  render: args => {
    ...
    const rowData = [{
      ...
      _rowDetails: <>
            ...
            <p>
              <strong>Start Date:</strong> January 15, 2022
            </p>
            <p>
              <strong>Notes:</strong> Excellent performance, leads the frontend
              team.
            </p>
            <div style={{
          marginTop: '12px'
      ...
      _rowDetails: <>
            ...
            <p>
              <strong>Position:</strong> Marketing Manager
            </p>
            <p>
              <strong>Application Date:</strong> December 1, 2024
            </p>
            <p>
              <strong>Status:</strong> Awaiting HR approval
            </p>
            <div style={{
          marginTop: '12px'
        }}>
      ...
      _rowDetails: <>
            ...
            <p>
              <strong>Position:</strong> Sales Director
            </p>
            <p>
              <strong>Last Active:</strong> November 20, 2024
            </p>
            <p>
              <strong>Reason:</strong> On extended leave
            </p>
            <div style={{
          marginTop: '12px'
        }}>
...
//# sourceMappingURL=Table.stories-ONFYAlDF.js.map
