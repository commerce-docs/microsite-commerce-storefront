  ...
  ci: {
    collect: {
      ...
      url: [
        ...
        'http://localhost/create/index.html',
        'http://localhost/create/explore-storefront/index.html',
        'http://localhost/create/discover-blocks/index.html',
        'http://localhost/create/discover-dropins/index.html',
