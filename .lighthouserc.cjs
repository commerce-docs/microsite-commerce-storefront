  ...
  ci: {
    collect: {
      ...
      url: [
        ...
        // 'http://localhost/best-practices/bp-containers/index.html',
        // 'http://localhost/best-practices/bp-slots/index.html',
        // 'http://localhost/best-practices/bp-events/index.html',
