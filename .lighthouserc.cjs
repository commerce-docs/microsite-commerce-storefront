  ...
  ci: {
    collect: {
      ...
      url: [
        ...
        'http://localhost/introduction/about-commerce-storefronts/index.html',
        'http://localhost/introduction/commerce-requirements/index.html',
        'http://localhost/dropin-components/what-are-dropins/index.html',
        ...
        'http://localhost/edge-delivery-tutorial/brand-style/brand-style/index.html',
        ...
        'http://localhost/edge-delivery-tutorial/customize-dropins/index.html',
        'http://localhost/edge-delivery-tutorial/launch-storefront/index.html',
      ],
    },
    upload: {
