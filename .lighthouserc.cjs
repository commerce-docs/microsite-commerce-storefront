  ...
  ci: {
    collect: {
      ...
      url: [
        ...
        'http://localhost/introduction/index.html',
        'http://localhost/introduction/commerce-blocks/index.html',
        'http://localhost/introduction/commerce-dropins/index.html',
        'http://localhost/introduction/content-blocks/index.html',
        'http://localhost/storefront-tutorial/index.html',
        'http://localhost/storefront-tutorial/brand/index.html',
        'http://localhost/storefront-tutorial/style/index.html',
        ...
        'http://localhost/product-details/pdp-api/index.html',
        'http://localhost/product-details/pdp-anatomy/index.html',
        'http://localhost/product-details/pdp-components/index.html',
        'http://localhost/product-details/pdp-css/index.html',
        'http://localhost/product-details/pdp-containers/index.html',
        'http://localhost/product-details/pdp-installation/index.html',
        'http://localhost/product-details/pdp-slots/index.html',
