  ...
  ci: {
    collect: {
      ...
      url: [
        ...
        'http://localhost/get-started/index.html',
        'http://localhost/get-started/explore-storefront/index.html',
        'http://localhost/get-started/discover-blocks/index.html',
        'http://localhost/get-started/discover-dropins/index.html',
        'http://localhost/customize/index.html',
        'http://localhost/customize/brand/index.html',
        'http://localhost/customize/style/index.html',
        'http://localhost/customize/extend/index.html',
        'http://localhost/customize/enrich/index.html',
        'http://localhost/customize/localize/index.html',
        'http://localhost/launch/index.html',
        'http://localhost/dropins/product-details/pdp-api/index.html',
        'http://localhost/dropins/product-details/pdp-anatomy/index.html',
