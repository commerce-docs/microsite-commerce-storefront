  ...
  ci: {
    collect: {
      ...
      url: [
        ...
        'http://localhost/storefront-tutorial/connect-services/index.html',
        'http://localhost/storefront-tutorial/style/style-dropins/index.html',
        'http://localhost/storefront-tutorial/create-content/index.html',
        'http://localhost/storefront-tutorial/localize-content/index.html',
        'http://localhost/storefront-tutorial/enrich-dropins/index.html',
        'http://localhost/storefront-tutorial/customize-dropins/index.html',
