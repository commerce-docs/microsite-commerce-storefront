...
For local development, you can use the boilerplate's demo configuration as a starting point. The live demo configuration is available at <Link href="https://main--aem-boilerplate-commerce--hlxsites.aem.live/config.json" text="https://main--aem-boilerplate-commerce--hlxsites.aem.live/config.json" /> and connects to the boilerplate's sample Commerce backend:
