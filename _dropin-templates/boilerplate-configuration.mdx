...
- **`.aem.live` Configuration Service** - Production configuration (default-site.json, default-fstab.yaml, default-sitemap.yaml, default-query.yaml are templates for setup)
