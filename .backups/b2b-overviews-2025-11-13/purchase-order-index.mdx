...
**[Drop-in developer]:** Replace this paragraph with a clear description of what the Purchase Order drop-in provides. Include:
...
Visit the [Purchase Order initialization](/dropins-b2b/purchase-order/initialization/) page to learn more.
...
Visit the [Purchase Order containers](/dropins-b2b/purchase-order/containers/) page to learn more.
...
Visit the [Purchase Order functions](/dropins-b2b/purchase-order/functions/) page to learn more.
...
Visit the [Purchase Order events](/dropins-b2b/purchase-order/events/) page to learn more.
...
Visit the [Purchase Order slots](/dropins-b2b/purchase-order/slots/) page to learn more.
...
Visit the [Purchase Order dictionary](/dropins-b2b/purchase-order/dictionary/) page to learn more.
...
Visit the [Purchase Order styles](/dropins-b2b/purchase-order/styles/) page to learn more.
