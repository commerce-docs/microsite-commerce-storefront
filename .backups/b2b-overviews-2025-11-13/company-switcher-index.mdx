...
**[Drop-in developer]:** Replace this paragraph with a clear description of what the Company Switcher drop-in provides. Include:
...
Visit the [Company Switcher initialization](/dropins-b2b/company-switcher/initialization/) page to learn more.
...
Visit the [Company Switcher containers](/dropins-b2b/company-switcher/containers/) page to learn more.
...
Visit the [Company Switcher functions](/dropins-b2b/company-switcher/functions/) page to learn more.
...
Visit the [Company Switcher events](/dropins-b2b/company-switcher/events/) page to learn more.
...
Visit the [Company Switcher slots](/dropins-b2b/company-switcher/slots/) page to learn more.
...
Visit the [Company Switcher dictionary](/dropins-b2b/company-switcher/dictionary/) page to learn more.
...
Visit the [Company Switcher styles](/dropins-b2b/company-switcher/styles/) page to learn more.
