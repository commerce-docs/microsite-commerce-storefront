...
Add a `metadata` table to the document to set the page's title, description, and structured data. At minimum, add a `title` and `description` for search results.
