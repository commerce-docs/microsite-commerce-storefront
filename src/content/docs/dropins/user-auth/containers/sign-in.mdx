...
Upon a successful login, the SignIn container renders the <Link href={"/dropins/user-auth/containers/success-notification/"} text={"SuccessNotification"} /> container. This container can be overridden using the Slots API.
