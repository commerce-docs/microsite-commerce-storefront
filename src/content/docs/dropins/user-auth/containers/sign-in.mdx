...
<OptionsTable
  ...
  options={[
    ...
    [
      ...
      'No',
      'Custom override for API error messages. Receives the original error object and returns a replacement message string. Use this to display brand-specific or user-friendly error messages on login failures.',
    ],
    [
      'onErrorCallback',
      'function',
