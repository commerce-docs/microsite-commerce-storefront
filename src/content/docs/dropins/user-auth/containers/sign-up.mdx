...
By default, upon a successful registration, the SignUp container renders the <Link href={"/dropins/user-auth/containers/success-notification/"} text={"SuccessNotification"} /> container.
