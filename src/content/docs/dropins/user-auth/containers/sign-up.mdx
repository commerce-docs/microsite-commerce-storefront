...
<OptionsTable
  ...
  options={[
    ...
    [
      ...
      'function',
      'No',
      'Allows passing the SuccessNotification or PrivacyPolicyConsent slot, or other custom component rendered upon successful sign-up, if routeRedirectOnSignIn is not provided.',
    ],
    [
      'routeSignIn',
      'function',
