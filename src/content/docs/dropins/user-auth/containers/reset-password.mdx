...
The user will also see an appropriate notification on the storefront. Clicking the link leads the user to the <Link href={"/dropins/user-auth/containers/update-password/"} text={"UpdatePassword container"} />.
