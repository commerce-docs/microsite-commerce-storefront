...
description: Learn about the ResetPassword container in the Adobe Commerce user auth drop-in documentation, including configuration options, props, and practical integration guidance for your storefront.
---
...
The user will also see an appropriate notification on the storefront. Clicking the link leads the user to the <Link href={"https://experienceleague.adobe.com/developer/commerce/storefront/dropins/user-auth/containers/update-password/"} text={"UpdatePassword container"} />.
...
<OptionsTable
    ...
    options={[
        ...
        ['onSuccessCallback', 'function', 'No', 'Callback executed when the password reset email is sent successfully.'],
    ]}
/>
