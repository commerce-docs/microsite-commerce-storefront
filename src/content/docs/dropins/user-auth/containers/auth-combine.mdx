...
description: Learn about the AuthCombine container in the Adobe Commerce user auth drop-in documentation, including configuration options, props, and practical integration guidance for your storefront.
---
