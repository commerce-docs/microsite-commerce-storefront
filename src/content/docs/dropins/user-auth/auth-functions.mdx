...
description: Learn about the API functions provided by the user auth drop-in component.
sidebar:
  # label: API
  order: 5
---
...
<OptionsTable
  ...
  options={[
    ...
    [
      ...
      'string',
      'Yes',
      'A key sent to the customer to confirm the request is legitimate.',
    ],
  ]}
/>
...
<OptionsTable
  ...
  options={[
    ...
    [
      ...
      'string',
      'Yes',
      'One of `customer_account_edit`, `customer_account_create`, `customer_register_address`, or `customer_address_edit`.',
    ],
  ]}
/>
...
<OptionsTable
  ...
  options={[
    ...
    [
      ...
      'string',
      'Yes',
      'The token sent to the customer to confirm the request is legitimate.',
    ],
