...
Returns [`CustomerModel`](#customermodel) (see structure below).
...
Returns [`PasswordResetEmailModel`](#passwordresetemailmodel) (see structure below).
...
Returns [`ResetPasswordModel`](#resetpasswordmodel) (see structure below).
...
Returns [`RevokeCustomerTokenModel`](#revokecustomertokenmodel) (see structure below).
