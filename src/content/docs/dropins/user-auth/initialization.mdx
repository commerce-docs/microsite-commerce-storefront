...
| `authHeaderConfig` | [`authHeaderConfig`](#authheaderconfig) | Yes | Configures authentication header format for API requests including custom header names and token prefix format (e.g., 'Bearer', 'Token'). |
