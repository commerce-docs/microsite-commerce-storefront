...
The `Buttons` slot allows you to customize the button row (e.g. forgot password, sign up link, submit).
...
The `Form` slot allows you to customize the main form area (password, confirm password, consent, etc.).

### Buttons slot

The `Buttons` slot allows you to customize the button row (e.g. sign in link, submit).
...
The slots for the `ResetPassword` container allow you to customize its appearance and behavior. The slot context (e.g. `ResetPasswordSlotContext`) includes properties such as `isLoading`.
...
The `Form` slot allows you to customize the main form area (e.g. email field for requesting the reset link).

### Buttons slot

The `Buttons` slot allows you to customize the button row (e.g. submit to request reset link).
...
The `Form` slot allows you to customize the update-password form (e.g. new password field and layout).
