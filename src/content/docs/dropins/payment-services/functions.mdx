...
The Payment Services drop-in provides API functions that enable you to programmatically control behavior, fetch data, and integrate with Adobe Commerce backend services.
...
For information about using this drop-in through its UI containers, see the [Containers](/dropins/payment-services/) documentation.
