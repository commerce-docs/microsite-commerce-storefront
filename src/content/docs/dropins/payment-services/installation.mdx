...
:::note
The Payment Services drop-in component requires the [Payment Services extension](https://experienceleague.adobe.com/en/docs/commerce-merchant-services/payment-services/release-notes#v2100) version 2.10.0 or higher.
:::
