...
| `payment-services/initialized/product-detail` | Drop-in initialized for the `PRODUCT_DETAIL`, with `event.availablePaymentMethods` determining the payment methods available for the product details page. |
</TableWrapper>
