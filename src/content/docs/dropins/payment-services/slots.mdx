...
This drop-in wraps the Adobe Payment Services SDK (`@adobe-commerce/payment-services-sdk`), which renders the credit card form and payment buttons (Apple Pay, Google Pay, and PayPal, etc.) into specified DOM elements.
