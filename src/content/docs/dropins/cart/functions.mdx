...
Emits the [`shipping/estimate`](/dropins/cart/events#shippingestimate-emits) event, which contains the transformed `ShippingMethod` data along with address information.
