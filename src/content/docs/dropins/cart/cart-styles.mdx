...
import EmptyCart from './files/emptyCart.css?raw';
import MiniCart from './files/miniCart.css?raw';
...
<CodeImport code={EmptyCart} title="emptyCart.css" lang="css" frame="none" />

<CodeImport code={MiniCart} title="miniCart.css" lang="css" frame="none" />
