{/*
  ...
  - @dropins/storefront-cart → Package name (e.g., "@dropins/storefront-cart")
  - 1.5.1 → Version number (e.g., "1.5.1")
  - 6 → Number of containers with slots
...
Learn about the slots provided in the **Cart** drop-in component for customizing container appearance and behavior.
