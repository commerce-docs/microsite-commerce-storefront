...
You might want to group and sort the order summary lines into sections using the Accordion component from the Storefront SDK (Elsie). See the <Link href="/sdk/components/accordion/" text="Accordion" /> component reference in this documentation.

:::note[Note]
For the full set of UI primitives (including icons), start from the <Link href="/sdk/components/overview/" text="Storefront SDK components overview" /> in this documentation.
:::
...
- [Add custom product lines](/dropins/cart/tutorials/add-product-lines-to-cart-summary/) — a related cart summary customization.
