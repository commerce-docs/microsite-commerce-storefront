...
description: Learn how to add gift options to a PDP. Follow this Adobe Commerce Cart tutorial to connect gift options on the PDP and cart summary using drop-in configuration and slots.
---
