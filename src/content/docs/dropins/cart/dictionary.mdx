...
The **Cart dictionary** contains all user-facing text and labels for localization and branding.

<div style="background-color: var(--sl-color-blue-low); border-left: 4px solid var(--sl-color-blue); padding: 0.75rem 1rem; border-radius: 0.25rem; margin: 1rem 0;">
<strong>Version: v1.5.1</strong>
</div>
...
```javascript title="scripts/config/dictionaries/cart-dictionary.js"
...
import { cartDictionary } from '../config/dictionaries/cart-dictionary.js';
