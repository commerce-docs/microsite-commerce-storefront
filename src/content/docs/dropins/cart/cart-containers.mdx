...
description: Learn about the containers in the Cart drop-in.
sidebar:
...
The Cart drop-in consists of two containers : `Cart` and `MiniCart`. Configuration options for both containers are provided below.
