...
<OptionsTable
  ...
  options={[
    ...
    ['slots', 'object', 'Yes', 'A slot object with two properties: OrderSummary and ProductList.' ],
    ['showDiscount', 'boolean', 'No', 'Whether to display the discount percentage of a discounted item.' ],
    ['showSavings', 'boolean', 'No', 'Whether to display the savings amount of a discounted item.' ],
    ['quantityType', 'stepper' | 'dropdown', 'No', 'Determine the quantity selector to use.' ],
    ['dropdownOptions', 'array', 'No', 'Provides an array of options for the dropdown input.' ],
  ]}
/>
...
<OptionsTable
  ...
  options={[
    ...
    ['routeCheckout', 'function', 'Yes', 'Callback function that navigates cart to checkout.'],
    ['slots', 'object', 'Yes', 'A slot object with one property: ProductList.' ],
    ['showDiscount', 'boolean', 'No', 'Whether to display the discount percentage of a discounted item.' ],
    ['showSavings', 'boolean', 'No', 'Whether to display the savings amount of a discounted item.' ],
  ]}
/>
