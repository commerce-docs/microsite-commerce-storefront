...
<OptionsTable
  ...
  options={[
    ...
    ['showDiscount', 'boolean', 'No', 'Whether to show the discount percentage of a discounted item.' ],
    ['showSavings', 'boolean', 'No', 'Whether to show the savings amount of a discounted item.' ],
