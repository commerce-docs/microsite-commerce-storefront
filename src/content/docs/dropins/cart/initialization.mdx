...
<strong>Version: 1.5.1 (documented from commit-f945b75)</strong>
</div>


<Aside type="caution" title="Version Mismatch">
The boilerplate specifies version **1.5.1**, but this documentation was generated from **commit-f945b75** because the specific version tag was not found in the repository. The documented configuration may differ from the published package version.
</Aside>
