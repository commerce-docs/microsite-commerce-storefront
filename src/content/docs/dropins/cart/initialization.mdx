...
| `disableGuestCart` | `boolean` | No | Disables guest cart functionality, requiring users to sign in before adding items to cart. Set to \`true\` to require authentication for cart operations. |
