...
The `langDefinitions` property is used to fetch and register dictionary files for the cart component. This allows you to provide localized text for different languages in your application.
