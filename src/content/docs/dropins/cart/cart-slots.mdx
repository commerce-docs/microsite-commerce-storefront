...
The OrderSummary slot allows you to customize the appearance of the order summary in the cart.

// Need example

### ProductList slot

The ProductList slot allows you to customize the appearance of the product list in the cart.
...
The `OrderSummary` container supports the following slots:
