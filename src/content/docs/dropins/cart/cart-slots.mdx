...
#### Example: Extend the Footer slot

The following example demonstrates how to add a promotional cart rule to each product in the cart.
...
#### Example: Extend the ProductAttributes slot
...
The slots for the OrderSummary container allow you to customize the appearance of the order summary.
...
#### Example: Extend the EstimateShipping slot
...
The Coupons slot allows you to add Coupons layout to the OrderSummary container. 

#### Example: Extend the Coupons slot
