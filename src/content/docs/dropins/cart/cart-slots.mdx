...
The slots for Cart Summary List are defined in the `CartSummaryListProps` interface. Each slot comes with a set of [primitive functions](/dropins/all/extending/) and may be extended with custom functions, such as `appendButton`.
