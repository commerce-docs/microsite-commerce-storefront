---
title: Cart slots
description: Learn about the slots provided in the cart component.
sidebar:
  order: 5
---
...
[Extending dropin-in components](/dropins/all/extending/) describes default properties available to all slots.
