...
description: Learn about the MiniCart container in the Adobe Commerce cart drop-in documentation, including configuration options, props, and practical integration guidance for your storefront.
---
