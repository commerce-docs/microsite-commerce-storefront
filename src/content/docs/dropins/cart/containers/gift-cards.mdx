...
<OptionsTable
	  ...
	  options={[
	    ...
	    ['className', 'string', 'No', 'CSS class applied to accordion.'],
	    ['accordionSectionTitle', 'string', 'No', 'Accordion section title overriding translation.'],
	    ['accordionSectionIcon', 'VNode', 'No', 'Coupons section icon.'],
