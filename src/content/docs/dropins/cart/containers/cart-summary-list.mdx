...
| `includeOutOfStockItems` | `boolean` | No | Dsiplay out-of-stock and insufficient-quantity items in the main cart item list alongside in-stock items. Default: `false`. |
