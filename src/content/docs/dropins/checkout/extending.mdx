...
See the [GraphQL Extensibility API](/sdk/reference/graphql/) and [Extending drop-in components](/dropins/all/extending/) documentation to learn more about how to extend the API for a drop-in component.
</Aside>