...
<OptionsTable
  ...
  options={[
    ...
    ['criteria', 'object', 'Yes', 'An object of type `ShippingEstimationCriteria`, which includes the following fields: `country_code`, `region_name`, `region_id`, and `zip`.'],
  ]}
/>
...
<OptionsTable
  ...
  options={[
    ['Parameter', 'Type', 'Req?', 'Description'],
    ['paymentMethod', 'string', 'Yes', 'A string representing the payment method to be set on the cart.'],
  ]}
/>
...
<OptionsTable
  ...
  options={[
    ['Parameter', 'Type', 'Req?', 'Description'],
    ['shippingMethods', 'ShippingMethodsOnCart', 'Yes', 'An An array of shipping methods of type ShippingMethodsOnCart.'],
  ]}
/>
