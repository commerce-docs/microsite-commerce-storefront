...
In the following example, the ShippingMethods container will be deactivated; this means it won't be rendered to the UI and won't listen to system events.
