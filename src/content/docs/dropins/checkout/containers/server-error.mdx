...
<li>The `autoScroll` property is a boolean to indicate if the page should scroll to the element containing the error message and put the focus on it to be visible to the user.</li>

<li>The `onRetry` property is a handler used to perform actions called when the retry button is clicked.</li>

<li>The `onServerError` property is a handler used to perform actions called when there is a new error message.</li>
