...
<li>The `onCartProductsUpdate` property is a handler used to perform actions called when there are out-of-stock items. It takes the list of items (array with pairs of _uid_ and _quantity_ values) as an input parameter.</li>

<li>The `routeCart` property is a handler used to indicate the route to the cart page.</li>
