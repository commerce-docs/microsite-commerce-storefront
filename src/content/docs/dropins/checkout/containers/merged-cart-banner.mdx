...
The `MergedCartBanner` is a _conditional_ container. It is designed to display a notification banner when items from an old cart are merged into the current cart.
