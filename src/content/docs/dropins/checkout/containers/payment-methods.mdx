...
<li>The `setOnChange` property has been _deprecated_ and will be removed in future versions. It has been replaced by `slots.Methods.<payment-method-code>.setOnChange`.</li>
