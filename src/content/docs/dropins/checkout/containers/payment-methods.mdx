...
## Example 1: List available payment methods without customization
...
## Example 2: How to use the `displayLabel` and `icon` configurations
...
## Example 3: How to use the `setOnChange` and `render` configurations
...
## Example 4: How to use the `enabled` configurations
...
import CreditCard, {
  ...
  GOOGLE_PAY_CODE,
  VAULT_CODE,
} from '@dropins/storefront-payment-services/containers/CreditCard.js';
