...
|---|---|---|---|
| `input` | `EstimateShippingInput` | No | See function signature above |

</TableWrapper>

### Returns

Returns an array of [`ShippingMethod`](#shippingmethod) objects or `null` (see structure below).
...
Returns an array of [`CheckoutAgreement`](#checkoutagreement) objects (see structure below).
...
| Parameter | Type | Req? | Description |
|---|---|---|---|
| `input` | `BillingAddressInputModel` | Yes | See function signature above |
...
| Parameter | Type | Req? | Description |
|---|---|---|---|
| `input` | `PaymentMethodInputModel` | Yes | See function signature above |
...
| Parameter | Type | Req? | Description |
|---|---|---|---|
| `input` | `ShippingAddressInputModel` | Yes | See function signature above |
