...
The function returns a promise that resolves to the array of transformed checkout agreements data fetched from the API or an empty array if no agreements enabled found.
