...
### Add your client token

After you configure the Braintree extension, you must add your client token to the Commerce boilerplate configuration.
...
1. Add a new key-value pair for your Braintree client token.

   | key                     | value             |
   |-------------------------|-------------------|
   | braintree-client-token  | YOUR_CLIENT_TOKEN |
