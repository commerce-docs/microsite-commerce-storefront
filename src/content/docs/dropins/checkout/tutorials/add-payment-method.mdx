...
<Aside type="tip" title="Supported payment providers">
  In addition to the Braintree example below, the Checkout drop-in also supports Adyen payment methods (including Bancontact) and payment extensions. See the [release notes](/releases/) for the latest supported providers.
</Aside>
