...
![Render initial containers without styles](@images/dropins/checkout/render-containers-no-styles.png)
</Diagram>
</Task>
...
![Render containers with styles](@images/dropins/checkout/render-containers-with-styles.png)
</Diagram>
</Task>
