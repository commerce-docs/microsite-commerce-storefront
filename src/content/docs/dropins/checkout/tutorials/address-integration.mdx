...
See [blocks/commerce-checkout-address-lookup](https://github.com/hlxsites/aem-boilerplate-commerce/blob/demos/blocks/commerce-checkout-address-lookup) in the `demos` branch of the boilerplate repository for complete JS and CSS code for the address verification flow.
