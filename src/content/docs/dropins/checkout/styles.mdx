...
The following example shows how to override two of the many classes for the Checkout dropin component.
...
<CodeImport
  code={billToShippingAddress}
  title="BillToShippingAddress.css"
  lang="css"
  frame="none"
/>
