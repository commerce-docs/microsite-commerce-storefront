...
This topic provides details and instructions for using the utility functions available in the checkout drop-in component. These functions were moved from the integration layer and are now publicly accessible within the checkout block from `@dropins/storefront-checkout/lib/aem.js`.
...
} from '@dropins/storefront-checkout/lib/aem.js';
```
...
```ts
import { setAddressOnCart } from '@dropins/storefront-checkout/lib/aem.js';
...
```ts
import { estimateShippingCost } from '@dropins/storefront-checkout/lib/aem.js';
...
The `isVirtualCart` function checks if a cart contains only virtual products (no shipping required).
...
```ts
import { isVirtualCart } from '@dropins/storefront-checkout/lib/aem.js';
...
```ts
import { isEmptyCart } from '@dropins/storefront-checkout/lib/aem.js';
...
```ts
import { getCartShippingMethod } from '@dropins/storefront-checkout/lib/aem.js';
...
```ts
import { getCartAddress } from '@dropins/storefront-checkout/lib/aem.js';
...
```ts
import { getCartPaymentMethod } from '@dropins/storefront-checkout/lib/aem.js';
...
```ts
import { createFragment } from '@dropins/storefront-checkout/lib/aem.js';
...
```ts
import { createFragment, createScopedSelector } from '@dropins/storefront-checkout/lib/aem.js';
...
```ts
import { validateForm } from '@dropins/storefront-checkout/lib/aem.js';
...
```ts
import { createMetaTag } from '@dropins/storefront-checkout/lib/aem.js';
...
```ts
import { setMetaTags } from '@dropins/storefront-checkout/lib/aem.js';
...
```ts
import { scrollToElement } from '@dropins/storefront-checkout/lib/aem.js';
...
```ts
import { transformAddressFormValuesToCartAddressInput } from '@dropins/storefront-checkout/lib/aem.js';
...
```ts
import { transformCartAddressToFormValues, getCartAddress } from '@dropins/storefront-checkout/lib/aem.js';
