...
await initialize({
  langDefinitions: {
    ...
    "Checkout": {
      "AddressValidation": {
        "title": "Custom Verify your address",
        "subtitle": "Custom To ensure accurate delivery, we suggest the changes highlighted below. Please choose which address you would like to use. If neither option is correct, edit your address."
      }
    }
  }
  }
