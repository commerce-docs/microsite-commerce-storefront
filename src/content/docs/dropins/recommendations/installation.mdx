...
sidebar:
  # label: Recommendations Installation
  order: 2
---
...
import Recommendations from '@dropins/storefront-cart/containers/Recommendations.js';
```
