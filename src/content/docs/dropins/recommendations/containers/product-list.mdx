...
description: Learn about the ProductList container in the Adobe Commerce recommendations drop-in documentation, including configuration options, props, and practical integration guidance for your storefront.
---
