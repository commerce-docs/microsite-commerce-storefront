...
|---|---|---|---|
| `request` | `SearchVariables | null` | Yes | See function signature above |
| `options` | `SearchOptions` | No | See function signature above |
...
Returns [`ProductSearchResult`](#productsearchresult) (see structure below).
