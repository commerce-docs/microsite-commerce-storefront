...
The `SortBy` container provides sorting options and manages sort state for search results. It offers customizable sort criteria, automatic sort state management, and supports both default and custom sort options for different use cases.
