...
The `Pagination` container manages pagination state and navigation for search results. It provides page navigation controls and automatically handles page state management based on search results.
