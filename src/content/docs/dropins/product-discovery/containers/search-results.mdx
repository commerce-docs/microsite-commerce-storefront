...
The `SearchResults` container is the primary container for displaying product search results and product information. It provides extensive customization options through slots, supports multiple scopes for isolated instances, and automatically handles loading states, error handling, and real-time updates.
