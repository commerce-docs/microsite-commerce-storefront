...
compact
    options={[
        ...
        ['withSearch', 'boolean', 'No', 'Whether to show the order search box. Full-size view only. Disabled by default.'],
...
A search term must be between 3 and 100 characters. The container does not submit a term shorter than three characters.
...
The search box appears in the full-size view only. The minified view does not render it.
