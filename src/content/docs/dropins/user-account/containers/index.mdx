...
| [AddressValidation](/dropins/user-account/containers/address-validation/) | Configure the `AddressValidation` container to present suggested and original addresses for shopper confirmation. |
...
| [PaymentMethods](/dropins/user-account/containers/payment-methods/) | List and remove stored payment methods (vault tokens) in My Account. |
