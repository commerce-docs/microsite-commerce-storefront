...
The `Addresses` container relies on the <Link href={"/dropins/user-account/containers/address-form/"} text={"AddressForm"} /> container for address creation and editing. It inherits all behaviors from the `AddressForm` container.
