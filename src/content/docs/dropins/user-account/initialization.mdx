...
| `authHeaderConfig` | [`authHeaderConfig`](#authheaderconfig) | No | Authentication header configuration for API requests. Specify the header name and token prefix format (e.g., \`Bearer\`) for authorization tokens. |
