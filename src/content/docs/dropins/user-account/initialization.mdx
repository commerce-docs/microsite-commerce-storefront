...
The **User Account initializer** configures customer account management features, including profile settings, address management, and order history. Use initialization to customize language definitions for account-related text displayed in customer dashboards.
...
| `authHeaderConfig` | `` | No | Configuration for authHeaderConfig. |
...
- [User Account Dictionary](/dropins/user-account/dictionary/) - Customize user-facing text and labels
- [User Account overview](/dropins/user-account/) - Learn about User Account features and capabilities
- [Installation guide](/dropins/user-account/installation/) - Install and set up the User Account drop-in
