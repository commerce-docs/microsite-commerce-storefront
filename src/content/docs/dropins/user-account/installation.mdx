...
description: Learn how to install the User Account drop-in component into your site.
sidebar:
  label: Installation
  order: 2
---
...
- @dropins/storefront-account: Full package name (e.g., "@dropins/storefront-cart")
- 1.2.0: Package version (e.g., "1.5.1")
- AddressForm: Name of a primary container for examples
- import { AddressForm } from '@dropins/storefront-account';: Generated import statement
- 5: Number of available containers
- https://github.com/adobe-commerce/storefront-account: Source repository URL
...
<strong>Version: 1.2.0</strong> | <strong>5 containers</strong>
</div>
...
<Aside type="tip">
See the [Containers documentation](/dropins/User Account/containers/) for a complete list of available containers and their configuration options.
</Aside>
