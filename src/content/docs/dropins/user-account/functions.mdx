...
Does not emit any drop-in events. To drive the UI from existing client data, emit **account/customerPaymentTokens** on the event bus (see [Events](../events/#accountcustomerpaymenttokens-listens)).
