...
The `createCustomerAddress` function creates an address for an existing customer using the `CustomerAddressesModel` object as an argument. The function calls the <Link href="https://developer.adobe.com/commerce/webapi/graphql/schema/customer/mutations/create-customer-address/" text="createCustomerAddress" /> mutation.
...
The `getCountries` function calls the <Link href="https://developer.adobe.com/commerce/webapi/graphql/schema/directory/queries/countries/" text="countries" /> query to retrieve a list of countries.
...
The `getRegions` function calls the <Link href="https://developer.adobe.com/commerce/webapi/graphql/schema/directory/queries/country/" text="country" /> query to retrieve a list of states or provinces for a specific country.
