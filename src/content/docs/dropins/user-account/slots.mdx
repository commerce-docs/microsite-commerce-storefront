...
The **PaymentMethods** container does not provide slots. Customize the layout and copy through [dictionary](/dropins/user-account/dictionary/) keys, [container props](/dropins/user-account/containers/payment-methods/#configurations), and [styles](/dropins/user-account/styles/#container-classes).
