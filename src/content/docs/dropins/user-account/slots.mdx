...
The **PaymentMethods** container does not define slots. Customize layout and copy through [dictionary](../dictionary/) keys, [container props](../containers/payment-methods/#configurations), and [styles](../styles/#container-classes).
