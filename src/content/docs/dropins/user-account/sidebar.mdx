...
The content of the `commerce-account-sidebar` block is fully manageable through Document Authoring, specifically within the `/customer/sidebar-fragment.docx` document. This structure allows for easy customization and updates, as shown in the following example:
