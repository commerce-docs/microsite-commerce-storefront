...
The **User Account dictionary** contains all user-facing text and labels for localization and branding.

<div style="background-color: var(--sl-color-blue-low); border-left: 4px solid var(--sl-color-blue); padding: 0.75rem 1rem; border-radius: 0.25rem; margin: 1rem 0;">
<strong>Version: v1.2.0</strong>
</div>
...
```javascript title="scripts/config/dictionaries/user-account-dictionary.js"
export const userAccountDictionary = {
  "Account": {
    "minifiedView": {
      "CustomerInformation": {
...
import { userAccountDictionary } from '../config/dictionaries/user-account-dictionary.js';

const langDefinitions = {
  default: {
    ...userAccountDictionary,
  },
};
