...
description: Learn about the slots provided in the Personalization drop-in for customization.
sidebar:
  label: Slots
  order: 5
tableOfContents:
...
Learn about the slots provided in the **Personalization** drop-in component for customizing container appearance and behavior.
