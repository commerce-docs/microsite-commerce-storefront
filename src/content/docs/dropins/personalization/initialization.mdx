...
description: Configure the Personalization drop-in with language definitions and custom data models.
sidebar:
...
The **Personalization** drop-in has no drop-in-specific configuration options or customizable models.
