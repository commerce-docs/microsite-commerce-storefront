...
Returns [`Wishlist`](#wishlist) or `null` (see structure below).
...
| Parameter | Type | Req? | Description |
|---|---|---|---|
| `wishlistId` | `string` | Yes | See function signature above |
...
Returns `void | Wishlist | null` (see [`Wishlist`](#wishlist) structure below).
...
| Parameter | Type | Req? | Description |
|---|---|---|---|
| `items` | `Array<Item>` | Yes | See function signature above |
