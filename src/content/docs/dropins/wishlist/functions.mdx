...
The `getWishlistById` function retrieves a wishlist by its ID. This is useful for loading a specific wishlist by identifier. The function calls the <Link href="https://developer.adobe.com/commerce/webapi/graphql/schema/wishlist/queries/wishlist/" text="wishlist_v2" /> query.
