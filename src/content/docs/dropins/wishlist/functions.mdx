...
| Parameter | Type | Req? | Description |
|---|---|---|---|
| `wishlistItemId` | `string` | Yes | See function signature above |
| `quantity` | `number` | Yes | See function signature above |
| `description` | `string` | Yes | See function signature above |
| `selectedOptions` | `string[]` | No | See function signature above |
| `enteredOptions` | `{ uid: string; value: string }[]` | No | See function signature above |
