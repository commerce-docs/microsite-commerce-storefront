...
description: Learn about the wishlist container in the Adobe Commerce wishlist drop-in documentation, including configuration options, props, and practical integration guidance for your storefront.
---
