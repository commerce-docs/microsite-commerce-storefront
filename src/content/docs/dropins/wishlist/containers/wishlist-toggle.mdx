...
description: Learn about the WishlistToggle container in the Adobe Commerce wishlist drop-in documentation, including configuration options, props, and practical integration guidance for your storefront.
---
