...
In the case of complex products with no variant selected in a wishlist, the move to cart button is disabled, and the user is prompted to select a variant first by navigating to the product details page.
