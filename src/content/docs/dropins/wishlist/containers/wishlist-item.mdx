...
description: Learn about the WishlistItem container in the Adobe Commerce wishlist drop-in documentation, including configuration options, props, and practical integration guidance for your storefront.
---
