...
The WishlistToggle container provides a button which allows the user to add and remove a specific product to / from a wishlist.
Its behavior and look and feel is driven by configuration options such as size and variant.
...
compact
    options={[
        ...
        ['product', 'object', 'Yes', 'The product to add or remove to / from a wishlist.'],
