...
<Tasks>
    ...
    <Task>
        ...
        Use a CDN or NPM (recommended for performance) to install the drop-in component tools (`@dropins/tools`) and product details (`@dropins/storefront-wishlist`) packages.
