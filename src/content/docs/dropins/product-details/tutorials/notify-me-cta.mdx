...
"Notify Me" is a frequently requested customization. This tutorial shows how to wire and update the CTA using the event bus, and how to subscribe the shopper with the drop-in's [`subscribeStockAlert`](/dropins/product-details/functions/#subscribestockalert) function. The CTA wiring stays in your block. The back-in-stock subscription itself is handled by the drop-in against Adobe Commerce.
</Aside>
