...
- **Image Carousel**: Display multiple product images and videos in a carousel format, allowing users to view different angles, details, and media of the product.
