...
<Diagram caption="The different containers that make up the product details page.">
  ![The different containers that make up the product details page.](@images/merchants/blocks/product-details-anatomy-developers.png)
</Diagram>
...
| Custom numeric attribute formatting (opt-in `formatValue` prop) | <Badge text="Supported" variant="tip" /> |
| Downloadable product options                                     | <Badge text="Supported" variant="tip" /> |
| Customizable options (priced selects, shopper-input fields) | <Badge text="Roadmap" variant="caution" /> |
