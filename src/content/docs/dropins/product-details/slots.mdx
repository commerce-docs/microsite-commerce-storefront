{/*
  ...
  - @dropins/storefront-pdp → Package name (e.g., "@dropins/storefront-cart")
  - 1.3.5 → Version number (e.g., "1.5.1")
  - 4 → Number of containers with slots
...
Learn about the slots provided in the **Product Details** drop-in component for customizing container appearance and behavior.
