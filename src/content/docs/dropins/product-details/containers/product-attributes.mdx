...
The `ProductAttributes` container provides the following slot for customization:

### Attributes

The `Attributes` slot allows you to replace the default attributes list rendering with custom content.
...
<OptionsTable
  ...
  options={[
    ...
    ['data', 'ProductModel | null', 'The current product data containing attributes and other product information.'],
  ]}
/>
