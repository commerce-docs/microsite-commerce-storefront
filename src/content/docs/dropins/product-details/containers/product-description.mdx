...
The `ProductDescription` container does not provide any slots. It renders the product description HTML directly. To customize the styling, use CSS classes or pass custom className via props.
