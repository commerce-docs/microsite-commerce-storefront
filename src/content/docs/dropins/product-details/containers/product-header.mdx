...
The `ProductHeader` container does not provide any slots. It renders the product name and SKU directly. To customize the styling, use CSS classes or pass custom className via props.
