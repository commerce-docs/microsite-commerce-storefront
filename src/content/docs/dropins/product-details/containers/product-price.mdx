...
The `ProductPrice` container does not provide any slots. It renders the product price and special price directly. To customize the styling, use CSS classes or pass custom className via props.