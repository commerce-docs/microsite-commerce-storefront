...
description: Learn about the configuration variables for the Product Details drop-in.
sidebar:
  order: 4
---
...
The PDP drop-in has a single container called `ProductDetails`. The container's configuration options are provided below.
