...
The **Product Details initializer** configures how product information is displayed, including SKU handling, option selection, ACDL tracking, and URL parameter persistence. Use initialization to customize product display behavior, enable analytics, and control how product options are presented.
