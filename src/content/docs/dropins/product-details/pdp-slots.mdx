---
title: PDP Slots
description: Learn about the slots provided in the product details component.
sidebar:
  order: 5
---
...
The product details component provides slots for nearly every part of its UI. The default UI controls for these PDP slots are described below.
