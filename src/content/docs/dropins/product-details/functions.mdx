...
The `ProductModel` object is returned by the following functions: [`getFetchedProductData`](#getfetchedproductdata), [`getFetchedProductData`](#getfetchedproductdata), [`getProductData`](#getproductdata), [`getProductData`](#getproductdata), [`getRefinedProduct`](#getrefinedproduct), [`getRefinedProduct`](#getrefinedproduct).
...
The `ValuesModel` object is returned by the following functions: [`getProductConfigurationValues`](#getproductconfigurationvalues), [`getProductConfigurationValues`](#getproductconfigurationvalues).
