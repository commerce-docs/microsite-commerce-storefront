...
<Aside type="note">
**Behind the scenes**: The boilerplate's placeholder system is a merchant-friendly abstraction over drop-in dictionaries. For multi-language support, advanced customization patterns, or if you're not using the boilerplate, see the [Dictionary customization guide](/dropins/all/dictionaries/).
</Aside>
