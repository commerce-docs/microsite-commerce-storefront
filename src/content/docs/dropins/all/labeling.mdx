...
description: Learn how to localize and relabel Adobe Commerce drop-in components using placeholder files, dictionary overrides, and merchant-friendly workflows on your storefront.
sidebar:
  label: Labels
  order: 5
---
...
**Merchants translating content:** See [Commerce localization tasks](/merchants/quick-start/content-localization-commerce-tasks/) for step-by-step guidance on <Term>localizing</Term> placeholder files for different locales.

**Developers implementing the system:** This guide explains how placeholder files integrate with drop-in dictionaries using `langDefinitions` <Term>language objects</Term>. For advanced customization beyond the placeholder system, see the [Dictionary customization guide](/dropins/all/dictionaries/).
