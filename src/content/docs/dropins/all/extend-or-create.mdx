...
<Aside type="caution" title='Early Access Warning'>
The drop-in SDK is currently early access with limited support for third parties. Building new drop-ins comes with these risks and limitations:
