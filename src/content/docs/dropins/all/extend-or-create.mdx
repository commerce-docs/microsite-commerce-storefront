...
If the feature doesn't fit inside any single drop-in container, you can combine an existing drop-in's API function, shared SDK components, and the event bus in a plain block instead. See [Blocks composition](/dropins/all/compose-a-block/).
</Aside>
