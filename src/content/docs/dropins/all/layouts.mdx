...
description: Learn how to configure HTML layouts for Commerce drop-in blocks on Edge Delivery Services so containers appear in the right order on product and category pages.
---
