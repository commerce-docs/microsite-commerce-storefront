...
[Content enrichment](/dropins/all/enriching/) is similar to adding content with slots. The difference is in scale. Enrichment is an Edge Delivery feature that allows you to add content to entire product categories.
