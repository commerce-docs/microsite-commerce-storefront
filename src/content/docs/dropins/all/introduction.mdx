...
B2B drop-ins extend the storefront for business-to-business workflows — company accounts, negotiated pricing, purchase orders, and bulk ordering. They use the same three-part anatomy (package, initializer, containers) as B2C drop-ins. They require a Commerce backend with B2B features enabled.
