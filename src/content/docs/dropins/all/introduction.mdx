...
authentication](/dropins/user-auth/) drop-in component provides users with a secure and seamless way to log in
...
<Badge text="In Development" variant="danger" /> The [user account](/dropins/user-account/) drop-in component
...
<OptionsTable
  options={[
    ...
    ['1.0.0', 'December 2024', '2.4.7', '4.7.0', '0.37.0', '- Cart 1.0.0 - PDP 1.0.0 - Checkout 1.0.0 - User Auth 1.0.0 - User Account 1.0.0 - Orders 1.0.0'],
  ]}
/>

| Suite Version | Released       | Adobe Commerce | Storefront compatibility package | Drop-in SDK | Drop-in versions                                                                 |
|---------------|----------------|----------------|----------------------------------|-------------|----------------------------------------------------------------------------------|
| 1.0.0         | December 2024  | 2.4.7          | 4.7.0                            | 0.37.0      | Product Details: 1.0.0<br/>Cart: 1.0.0<br/>Checkout: 1.0.0<br/>User Auth: 1.0.0<br/>User Account: 1.0.0<br/>Orders: 1.0.0 |
