...
The [Payment Services](/dropins/payment-services/) drop-in is a key component, allowing users to efficiently oversee payment and order data from all of your storefronts in one place — your Commerce dashboard. By leveraging Payment Services, merchants can focus on growing their business while providing their customers with a smooth and trustworthy checkout experience.
