...
| [Build custom features](/blocks/build-custom-features/) | Combine an existing drop-in's API function, shared SDK components, and the event bus in a plain block, without creating a new drop-in. |
