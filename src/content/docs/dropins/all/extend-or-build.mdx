...
Building a new drop-in is the process of creating a new drop-in from scratch.
...
Public events are the process of firing an event from a drop-in.
...
Should be extremely rare. Consider whether improving extension points yields lower ecosystem friction.
