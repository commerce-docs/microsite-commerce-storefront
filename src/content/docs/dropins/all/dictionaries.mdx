...
- **Need specific drop-in keys?** → See individual dictionary pages: [Cart](/dropins/cart/dictionary/), [Checkout](/dropins/checkout/dictionary/), [Product Details](/dropins/product-details/dictionary/), etc.
</Aside>
...
1. **Find the dictionary keys:** Check your drop-in's dictionary page ([Cart](/dropins/cart/dictionary/), [Checkout](/dropins/checkout/dictionary/), etc.).
...
**On GitHub:** [Cart](https://github.com/adobe-commerce/storefront-cart/blob/main/src/i18n/en_US.json) • [Checkout](https://github.com/adobe-commerce/storefront-checkout/blob/main/src/i18n/en_US.json) • (etc.)
...
1. **Keep placeholders** - Values with `{count}`, `{price}`, etc. must keep these placeholders for dynamic data injection
