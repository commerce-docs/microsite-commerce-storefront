...
The `PaymentMethodIcon` slot renders custom elements based on selected payment method on order details page.
...
The `DeliveryTimeLine` slot renders a custom stepper to track delivery process.
