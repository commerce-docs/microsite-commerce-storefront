...
To customize the label text, override the `Order.OrderStatusContent.adminAssistedLabel` dictionary key in the order initializer. See the [Order dictionary](/dropins/order/dictionary/) for the key and [Seller-assisted buying](/storefront-features/seller-assisted-buying/) for the end-to-end flow.
