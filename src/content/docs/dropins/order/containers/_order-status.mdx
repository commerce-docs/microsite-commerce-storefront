...
- <Link href={"https://experienceleague.adobe.com/en/docs/commerce-admin/stores-sales/order-management/returns/rma-configure"} text={"Returns"} />
- <Link href={"https://experienceleague.adobe.com/en/docs/commerce-admin/stores-sales/shopper-tools/reorders-allow"} text={"Allow reorders"} />
- <Link href={"https://experienceleague.adobe.com/en/docs/commerce-admin/stores-sales/shopper-tools/cancel-allow"} text={"Allow order cancellations"} />
