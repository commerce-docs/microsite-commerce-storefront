...
description: Learn about the ReturnsList container in the Adobe Commerce order drop-in documentation, including configuration options, props, and practical integration guidance for your storefront.
---
