...
The **Order dictionary** contains all user-facing text and labels for localization and branding.
...
```javascript title="scripts/config/dictionaries/order-dictionary.js"
...
import { orderDictionary } from '../config/dictionaries/order-dictionary.js';
