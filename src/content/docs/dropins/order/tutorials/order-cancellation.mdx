...
<OptionsTable
  ...
  options={[
    ...
    ['Order cancellation reasons', 'A set of reasons that the shopper selects from to explain why they want to cancel the order. You can customize the default options to provide a list that is applicable to your business.'],
    ]}
/>
