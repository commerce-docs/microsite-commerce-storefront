...
- The [Compatibility Package](/setup/configuration/storefront-compatibility/) installed on your Adobe Commerce backend
...
- [Compatibility Package](/setup/configuration/storefront-compatibility/)
