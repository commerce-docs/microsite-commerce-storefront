...
Adobe Commerce drop-ins are available exclusively to customers with active Adobe Commerce as a Cloud Service or Adobe Commerce Optimizer licenses. This page provides information about licensing requirements, how to access drop-ins, and what you need to know about versioning.
...
3. **Documentation** - Complete implementation guides and API references are available in this *Adobe Commerce Storefront* documentation.
...
- The [Storefront Compatibility Package](/setup/configuration/storefront-compatibility/) installed on your Adobe Commerce backend
...
- Terms for Adobe Commerce customers (Adobe Commerce as a Cloud Service or Adobe Commerce Optimizer license holders)
...
### Can I use drop-ins without an Adobe Commerce as a Cloud Service or Adobe Commerce Optimizer license?
...
- [Storefront Compatibility Package](/setup/configuration/storefront-compatibility/)
