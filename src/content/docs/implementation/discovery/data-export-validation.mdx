...
Data export synchronizes data between an Adobe Commerce instance and connected [storefront services](/implementation/discovery/requirements/). Storefront services are required for dropins to work correctly.
