...
* Reach out to the Adobe team early to share your use cases and get the recommendations about how to fulfill them: [mailto:commerce-storefront-compatibility@adobe.com](commerce-storefront-compatibility@adobe.com)
