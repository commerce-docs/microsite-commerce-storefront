...
The following snippet does a simple redirect if `host` does not contain `www`. It adds it and then redirects to `https` using a [Fastly-specific error code](https://www.fastly.com/documentation/reference/http/http-statuses/).
