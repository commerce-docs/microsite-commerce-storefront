...
* The configuration values with the core Adobe Commerce GraphQL endpoint that you configured as part of the [content delivery network (CDN) setup](/implementation/setup/content-delivery-network/).
