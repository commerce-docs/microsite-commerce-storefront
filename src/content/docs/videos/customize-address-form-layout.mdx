...
editUrl: 'https://github.com/commerce-docs/microsite-commerce-storefront/blob/release/src/content/docs/videos/customize-address-form-layout.mdx'
---
  ...
  <div style="max-width: 760px;">
    <Aside type="note" title="Looking for the documentation?">
      ...
      <ul>
        <li>
          <a
            href={setBasePath("/dropins/checkout/tutorials/address-integration/")}
            >Address verification</a>
        </li>
        <li>
          <a
            href={setBasePath("/dropins/user-account/tutorials/customize-layout/")}
            >Customize the address form layout</a>
        </li>
        <li>
          <a
            href={setBasePath("/dropins/user-account/sidebar/")}
