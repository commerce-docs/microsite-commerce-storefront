...
description:
  'Learn how to customize the lines of the order summary in the cart drop-in component.'
editUrl: 'https://github.com/commerce-docs/microsite-commerce-storefront/blob/release/src/content/docs/videos/customize-order-summary-lines.mdx'
---
...
import { setBasePath } from '@utils/basePath';
  ...
  <div style="max-width: 760px;">
    <Aside type="note" title="Looking for the documentation?">
      See the <a
        href={setBasePath("/dropins/cart/tutorials/order-summary-lines/")}>
        text-based
