...
import { setBasePath } from '@utils/basePath';
  ...
  <div style="max-width: 760px;">
    <Aside type="note" title="Looking for the documentation?">
      See the <a
        href={setBasePath("/dropins/cart/tutorials/configure-cart-summary/")}>text-based</a> version of this video tutorial for step-by-step instructions and code samples.
    </Aside>
  </div>
