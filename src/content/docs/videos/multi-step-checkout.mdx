...
editUrl: 'https://github.com/commerce-docs/microsite-commerce-storefront/blob/release/src/content/docs/videos/multi-step-checkout.mdx'
---
...
import { setBasePath } from '@utils/basePath';
  ...
  <div style="max-width: 760px;">
    <Aside type="note" title="Looking for the documentation?">
      See the <a
        href={setBasePath("/dropins/checkout/tutorials/multi-step/")}>text-based</a> version of this video tutorial for step-by-step instructions and code samples.
    </Aside>
  </div>
