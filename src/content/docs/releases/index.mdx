...
| April 2025 | | `2.4.7` | `4.7.1` |  <ul><li>`@dropins/tools@1.0.0`</li><li>`@dropins/build-tools@0.2.0`</li></ul> | <ul><li>`@dropins/storefront-cart@1.2.2`</li><li>`@dropins/storefront-checkout@1.3.0`</li><li>`@dropins/storefront-order@1.0.5`</li><li>`@dropins/storefront-payment-services@1.0.1`</li><li>`@dropins/storefront-pdp@1.0.0`</li><li>`@dropins/storefront-user-account@1.0.4`</li><li>`@dropins/storefront-user-auth@1.0.6`</li></ul> |
