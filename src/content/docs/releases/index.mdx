...
This suite release delivers significant enhancements to existing drop-in components, providing improved functionality and better user experiences for your storefront.
...
| Checkout | • [Configure terms and conditions](/merchants/get-started/terms-and-conditions/)<br/>• [Multi-step checkout](/dropins/checkout/tutorials/multi-step/)<br/>• [Improved error handling](/dropins/checkout/error-handling/) |
| PDP | • Supports updating cart items by URL (`itemUid`) |
| Storefront Compatibility Package (SCP) | • Secure personalization features<br/>• Social login integration APIs |
| Boilerplate | • Upgraded boilerplate to Helix 5<br/>• Improvements to scaffolding tool<br/>• Centralized configuration through NPM<br/>• Updated the localization approach across the boilerplate<br/>• Eliminated the need to manage or modify configuration logic manually. Updates can now be delivered through standard package upgrades. |
