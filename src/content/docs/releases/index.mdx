...
This suite moves the storefront to Drop-in SDK (Elsie) 1.8.0, adds product video in the product detail gallery, extends checkout shipping with slots and GraphQL fragments, and ships Quick Order v1.0.0 in the B2B boilerplate. B2C changes merged in ([#1152](https://github.com/hlxsites/aem-boilerplate-commerce/pull/1152)); B2B changes merged in ([#1156](https://github.com/hlxsites/aem-boilerplate-commerce/pull/1156)). For per-component version details, see the [changelog](/releases/changelog/).

### Highlights

#### Product gallery video on the PDP

Merchants can show catalog video in the product gallery without a custom player. The boilerplate demonstrates optional `videos` configuration on the product detail block ([#1100](https://github.com/hlxsites/aem-boilerplate-commerce/pull/1100)). The Product Details Page drop-in adds gallery props, video utilities, and catalog data support ([#57](https://github.com/adobe-commerce/storefront-pdp/pull/57)).

#### Checkout shipping customization and pickup extensions

You can replace how each shipping method renders and extend estimated shipping with custom GraphQL. The ShippingMethods container adds a `ShippingMethodItem` slot; `estimateShippingMethods` supports a fragment extension model ([#300](https://github.com/adobe-commerce/storefront-checkout/pull/300), [#307](https://github.com/adobe-commerce/storefront-checkout/pull/307)); hooks and samples support custom shipping UI ([#305](https://github.com/adobe-commerce/storefront-checkout/pull/305), [#303](https://github.com/adobe-commerce/storefront-checkout/pull/303)). Address autocomplete and buy online, pick up in store (BOPIS) ship as extension patterns ([#299](https://github.com/adobe-commerce/storefront-checkout/pull/299)).

#### Multi-store wishlist and translation overrides

Shoppers keep separate guest and authenticated wishlist data per store view when you pass an optional `storeCode` during initialization ([#73](https://github.com/adobe-commerce/storefront-wishlist/pull/73)). Wishlist, Personalization, and several B2B drop-ins merge custom `langDefinitions` with bundled defaults so label overrides apply consistently ([#79](https://github.com/adobe-commerce/storefront-wishlist/pull/79), [#27](https://github.com/adobe-commerce/storefront-personalization/pull/27)).

#### PDP data, options, and pricing display

The Product Details Page drop-in adds `getProductsData` for bulk SKU loads used by Quick Order ([#56](https://github.com/adobe-commerce/storefront-pdp/pull/56)), a `transformer` prop on product options ([#51](https://github.com/adobe-commerce/storefront-pdp/pull/51)), optional variant SKU labeling ([#63](https://github.com/adobe-commerce/storefront-pdp/pull/63)), and number formatting on product attributes ([#65](https://github.com/adobe-commerce/storefront-pdp/pull/65)). Pricing display with Adobe Commerce Optimizer and PaaS is corrected for wishlist flows ([#58](https://github.com/adobe-commerce/storefront-pdp/pull/58)).

#### Quick Order for B2B

The B2B boilerplate pins `@dropins/storefront-quick-order` at v1.0.0 ([#1156](https://github.com/hlxsites/aem-boilerplate-commerce/pull/1156)). The Quick Order drop-in includes the Variants Grid container, stronger Cypress coverage, and language-definition merging ([#21](https://github.com/adobe-commerce/storefront-quick-order/pull/21), [#23](https://github.com/adobe-commerce/storefront-quick-order/pull/23)).

### Updated boilerplate

#### Infrastructure

- **Drop-in SDK and build tools**: `@dropins/tools` ~1.7.0 → ~1.8.0; `@dropins/build-tools` ~1.0.1 → 1.1.0 ([#1152](https://github.com/hlxsites/aem-boilerplate-commerce/pull/1152), [#1156](https://github.com/hlxsites/aem-boilerplate-commerce/pull/1156)).

#### Document Authoring

- **Component models**: Updates to `component-models.json` for authoring alignment with the suite ([#1152](https://github.com/hlxsites/aem-boilerplate-commerce/pull/1152)).

#### Fixes and improvements

- **Layout**: Full-width sections and padding-based gutters in default styles ([#1133](https://github.com/hlxsites/aem-boilerplate-commerce/pull/1133)).
- **Product List Page**: Search and URL handling refactors, including a dedicated `search-url` helper and README updates ([#1152](https://github.com/hlxsites/aem-boilerplate-commerce/pull/1152)).
- **Product detail block**: Example wiring for optional gallery video ([#1100](https://github.com/hlxsites/aem-boilerplate-commerce/pull/1100)).
- **Demo configuration**: Default demo configs enable AEM Assets ([#1114](https://github.com/hlxsites/aem-boilerplate-commerce/pull/1114)); ACO demo config defaults the Adobe Commerce Optimizer flag ([#1124](https://github.com/hlxsites/aem-boilerplate-commerce/pull/1124)).
...
- **GraphQL client generation** - `skipFragments` can be combined with explicit operation lists for predictable client output ([#178](https://github.com/adobe-commerce/StorefrontSDK/pull/178)).
- **Elsie 1.8.0** - Drop-ins in this suite build on `@adobe-commerce/elsie` 1.8.0 ([#1152](https://github.com/hlxsites/aem-boilerplate-commerce/pull/1152)).

### Updated storefront tools

- **`@dropins/build-tools` 1.1.0** - Vite-based dist builds emit `package.json`, license, and changelog assets for published packages, alongside Changesets-driven release automation ([#1152](https://github.com/hlxsites/aem-boilerplate-commerce/pull/1152)).

### Updated drop-in components

| Component | Improvements |
|-----------|--------------|
| [**Cart**](/dropins/cart/) v3.2.0 | `includeOutOfStockItems` on CartSummaryList; Elsie 1.8.0 ([#102](https://github.com/adobe-commerce/storefront-cart/pull/102)) |
| [**Checkout**](/dropins/checkout/) v3.2.0 | `ShippingMethodItem` slot; `estimateShippingMethods` GraphQL extension; shipping-methods hooks and extension samples; BOPIS and address autocomplete samples; Elsie 1.8.0 ([#299](https://github.com/adobe-commerce/storefront-checkout/pull/299), [#300](https://github.com/adobe-commerce/storefront-checkout/pull/300), [#307](https://github.com/adobe-commerce/storefront-checkout/pull/307)) |
| [**Order**](/dropins/order/) v3.2.0 | Exported guest and customer order fragments for GraphQL extension; authenticated orders no longer use the guest cancellation path by mistake ([#70](https://github.com/adobe-commerce/storefront-order/pull/70), [#82](https://github.com/adobe-commerce/storefront-order/pull/82)) |
| [**Product Details Page**](/dropins/product-details/) v3.0.2 | Gallery video support; `getProductsData`; options `transformer`; variant SKU display options; `formatValue` on product attributes; ACO and PaaS wishlist price fix ([#51](https://github.com/adobe-commerce/storefront-pdp/pull/51), [#56](https://github.com/adobe-commerce/storefront-pdp/pull/56), [#57](https://github.com/adobe-commerce/storefront-pdp/pull/57), [#58](https://github.com/adobe-commerce/storefront-pdp/pull/58), [#63](https://github.com/adobe-commerce/storefront-pdp/pull/63), [#65](https://github.com/adobe-commerce/storefront-pdp/pull/65)) |
| [**User Account**](/dropins/user-account/) v3.2.0 | `orderTime` on order models and `OrdersListOrderTime` slot; CustomerOrder fragment extension ([#45](https://github.com/adobe-commerce/storefront-account/pull/45), [#46](https://github.com/adobe-commerce/storefront-account/pull/46)) |
| [**User Auth**](/dropins/user-auth/) v3.2.0 | Title, form, and button slots across auth containers; Reset Password slot fixes ([#58](https://github.com/adobe-commerce/storefront-auth/pull/58), [#64](https://github.com/adobe-commerce/storefront-auth/pull/64)) |
| [**Wishlist**](/dropins/wishlist/) v3.2.0 | Multi-store storage and cookies; `langDefinitions` merge ([#73](https://github.com/adobe-commerce/storefront-wishlist/pull/73), [#79](https://github.com/adobe-commerce/storefront-wishlist/pull/79)) |
| [**Personalization**](/dropins/personalization/) v3.1.1 | `langDefinitions` merge; Elsie 1.8.0 ([#27](https://github.com/adobe-commerce/storefront-personalization/pull/27)) |
| [**Product Discovery**](/dropins/product-discovery/) v3.1.0 | Pathname handling when the store code appears in the URL; quick search behavior ([#88](https://github.com/adobe-commerce/storefront-search-dropin/pull/88), [#91](https://github.com/adobe-commerce/storefront-search-dropin/pull/91)) |
| [**Product Recommendations**](/dropins/recommendations/) v3.0.0 | Elsie 1.8.0 alignment; no user-facing changes |
...
| Component | Improvements |
|-----------|--------------|
| [**Company Management**](/dropins-b2b/company-management/) v1.2.0 | Initializer matches other drop-ins; `langDefinitions` merge ([#77](https://github.com/adobe-commerce/storefront-company-management/pull/77), [#76](https://github.com/adobe-commerce/storefront-company-management/pull/76)) |
| [**Company Switcher**](/dropins-b2b/company-switcher/) v1.1.1 | Elsie 1.8.0 alignment; no user-facing changes |
| [**Purchase Order**](/dropins-b2b/purchase-order/) v1.1.1 | Elsie 1.8.0 alignment; no user-facing changes |
| [**Quote Management**](/dropins-b2b/quote-management/) v1.1.2 | `langDefinitions` merge ([#89](https://github.com/adobe-commerce/storefront-quote-management/pull/89)) |
| [**Requisition List**](/dropins-b2b/requisition-list/) v1.2.0 | Catalog integration uses injected props instead of internal API helpers; `langDefinitions` merge ([#114](https://github.com/adobe-commerce/storefront-requisition-list/pull/114), [#124](https://github.com/adobe-commerce/storefront-requisition-list/pull/124)) |
| [**Quick Order**](/dropins-b2b/quick-order/) v1.0.0 | Variants grid container; language overrides; suite integration ([#1156](https://github.com/hlxsites/aem-boilerplate-commerce/pull/1156), [#21](https://github.com/adobe-commerce/storefront-quick-order/pull/21)) |
