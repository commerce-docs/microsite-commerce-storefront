...
| Checkout | • [Configure terms and conditions](/merchants/get-started/terms-and-conditions/)<br/>• [Improved error handling](/dropins/checkout/error-handling/)<br/>• [Improved event handling](/dropins/all/events/) |
