...
|-----------|--------------|
| [**Cart**](/dropins/cart/) | TODO |
| [**Checkout**](/dropins/checkout/) | TODO |
| [**Order**](/dropins/order/) | TODO |
| [**Personalization**](/dropins/personalization/) | TODO |
| [**Product Details Page**](/dropins/product-details/) | TODO |
| [**Product Discovery**](/dropins/product-discovery/) | TODO |
| [**Product Recommendations**](/dropins/recommendations/) | TODO |
| [**User Account**](/dropins/user-account/) | TODO |
| [**User Authentication**](/dropins/user-auth/) | TODO |
| [**Wishlist**](/dropins/wishlist/) | TODO |
...
- **Order drop-in**: When a customer has an order containing out-of-stock products, the entire order list appears empty (even if other orders exist) due to attempting to access an undefined `url_key` property on the out-of-stock product.
