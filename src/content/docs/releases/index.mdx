...
The `ShippingMethods` container configuration structure has been modified. The `ShippingMethodsProps` interface extends the `TitleProps` interface inheriting the following properties:
