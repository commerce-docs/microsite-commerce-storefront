...
- **Enhanced checkout experience**: Improved the Checkout drop-in with reusable utility libraries, better zero-payment handling for fully discounted orders, and AEM Assets integration for gift options with visual swatch support.
...
- **Security enhancements**: Implemented a Secure flag for authentication cookies, ensuring cookies are only transmitted over HTTPS connections for improved security compliance and protection against man-in-the-middle attacks.
