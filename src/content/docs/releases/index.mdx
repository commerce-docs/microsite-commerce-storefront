...
Check the [Terms And Conditions](/dropins/checkout/containers/terms-and-conditions) documentation for more information.
...
See the [Place Order](/dropins/checkout/containers/place-order) documentation for more information.
