...
Please see the [Terms And Conditions](/dropins/checkout/containers/terms-and-conditions) documentation for more details.
...
Please see the [Place Order](/dropins/checkout/containers/place-order) documentation for more details.
...
Please see the [Payment Methods](/dropins/checkout/containers/payment-methods) documentation for more details.
