...
************************************/}
    ...
    >
      ...
      >
          ...
          - **Purchase Order**: Added validation to block purchase order creation when credit limit exceed is disabled and credit is lower than the order total. Fixed internal server errors in `placePurchaseOrder`, `customer.purchase_order`, and `customer.purchase_orders` when using negotiable quotes.
