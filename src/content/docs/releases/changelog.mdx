...
************************************/}
      ...
      >
          ...
          - **Cart Items**: Resolved an issue where only_x_left_in_stock returned null in the Cart Details GraphQL response for products with backorders enabled. The problem was caused by incorrect calculations of the Out-of-Stock Threshold.
      </ChangelogEntry>
