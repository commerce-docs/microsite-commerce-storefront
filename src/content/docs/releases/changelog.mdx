...
***************/}
    ...
    >
      The Commerce boilerplate has been updated for the March 2026 suite. B2C changes merged in ([#1152](https://github.com/hlxsites/aem-boilerplate-commerce/pull/1152)); B2B changes merged in ([#1156](https://github.com/hlxsites/aem-boilerplate-commerce/pull/1156)).

      **Infrastructure and dependencies**

      - **Drop-in SDK and build tools** - `@dropins/tools` ~1.8.0 and `@dropins/build-tools` 1.1.0 across B2C and B2B package lines.

      **Product experience**

      - **Product gallery video** - Product detail block demonstrates optional `videos` configuration for catalog video in the gallery ([#1100](https://github.com/hlxsites/aem-boilerplate-commerce/pull/1100)).
      - **Product List Page** - Search and URL handling refactors with a dedicated `search-url` module and expanded README ([#1152](https://github.com/hlxsites/aem-boilerplate-commerce/pull/1152)).

      **Layout and configuration**

      - **Columns and gutters** - Full-width sections and padding-based gutters in shared styles ([#1133](https://github.com/hlxsites/aem-boilerplate-commerce/pull/1133)).
      - **Demo defaults** - Demo configs default AEM Assets on ([#1114](https://github.com/hlxsites/aem-boilerplate-commerce/pull/1114)); ACO demo config defaults the Adobe Commerce Optimizer flag ([#1124](https://github.com/hlxsites/aem-boilerplate-commerce/pull/1124)).
      - **Repository metadata** - Removed folders map reference ([#1148](https://github.com/hlxsites/aem-boilerplate-commerce/pull/1148)).

      **B2B**

      - **Quick Order** - B2B `package.json` adds `@dropins/storefront-quick-order@~1.0.0` ([#1156](https://github.com/hlxsites/aem-boilerplate-commerce/pull/1156)).
...
*****************/}
    ...
    >
      ...
      - **GraphQL client generation** - `skipFragments` can be combined with explicit operation lists so generated clients stay predictable ([#178](https://github.com/adobe-commerce/StorefrontSDK/pull/178)).
      - **Release and build pipeline** - Changesets integration, Vite dist output, and publish tooling updates support the 1.8.0 release line (for example [#181](https://github.com/adobe-commerce/StorefrontSDK/pull/181), [#184](https://github.com/adobe-commerce/StorefrontSDK/pull/184)).
...
********/}
    ...
    >
      ...
      - **`includeOutOfStockItems`** - `CartSummaryList` accepts `includeOutOfStockItems` so you can include out-of-stock lines when needed ([#102](https://github.com/adobe-commerce/storefront-cart/pull/102)).
      - **Elsie 1.8.0** - Updated to `@adobe-commerce/elsie` 1.8.0 for suite alignment.
...
************/}
    ...
    >
      ...
      - **Shipping method item slot** - `ShippingMethods` exposes a `ShippingMethodItem` slot so you can replace the default shipping method row while keeping selection behavior ([#300](https://github.com/adobe-commerce/storefront-checkout/pull/300)).
      - **`estimateShippingMethods` extensibility** - GraphQL fragment extension via `EstimateShippingModel` and `ESTIMATE_SHIPPING_METHOD_FRAGMENT` ([#307](https://github.com/adobe-commerce/storefront-checkout/pull/307)).
      - **Shipping methods hooks** - `checkout/shipping-methods-render` hook and custom shipping methods extension sample ([#305](https://github.com/adobe-commerce/storefront-checkout/pull/305), [#308](https://github.com/adobe-commerce/storefront-checkout/pull/308)).
      - **Extensions block** - Checkout-with-extensions sample uses the SDK extension manager ([#303](https://github.com/adobe-commerce/storefront-checkout/pull/303)).
      - **Address autocomplete and BOPIS** - Extension samples for address autocomplete and buy online, pick up in store flows ([#299](https://github.com/adobe-commerce/storefront-checkout/pull/299)).
      - **Elsie 1.8.0** - Updated to `@adobe-commerce/elsie` 1.8.0.
...
*********/}
    ...
    >
      ...
      - **GraphQL fragment extension** - Exported fragments enable extending CustomerOrder data through `overrideGQLOperations` ([#70](https://github.com/adobe-commerce/storefront-order/pull/70)).
      - **Guest vs authenticated cancellation** - Separate customer order fragment without the guest token field fixes authenticated orders incorrectly using the guest cancellation path ([#82](https://github.com/adobe-commerce/storefront-order/pull/82)).
      - **Elsie 1.8.0** - Updated to `@adobe-commerce/elsie` 1.8.0.
...
********************/}
    ...
    >
      The Payment Services drop-in version is aligned with the March 2026 suite at `~3.0.0`. There are no user-facing changes in this release.
...
*******************/}
    ...
    >
      ...
      - **`langDefinitions` merge** - The Provider merges custom `langDefinitions` from the initializer with bundled defaults ([#27](https://github.com/adobe-commerce/storefront-personalization/pull/27)).
      - **Elsie 1.8.0** - Updated to `@adobe-commerce/elsie` 1.8.0.
...
************************/}
    ...
    >
      ...
      - **Gallery video** - Product gallery supports catalog video with configurable ordering relative to images ([#57](https://github.com/adobe-commerce/storefront-pdp/pull/57)).
      - **`getProductsData` API** - Bulk product fetch API supports Quick Order and similar integrations ([#56](https://github.com/adobe-commerce/storefront-pdp/pull/56)).
      - **Options `transformer`** - `ProductOptions` accepts a `transformer` prop for option type conversion ([#51](https://github.com/adobe-commerce/storefront-pdp/pull/51)).
      - **Wishlist pricing** - Fixed pricing display for wishlist flows with Adobe Commerce Optimizer and PaaS ([#58](https://github.com/adobe-commerce/storefront-pdp/pull/58)).
      - **Variant labels** - Optional variant SKU labeling ([#63](https://github.com/adobe-commerce/storefront-pdp/pull/63)).
      - **Attribute number formatting** - `formatValue` on `ProductAttributes` formats numeric attributes ([#65](https://github.com/adobe-commerce/storefront-pdp/pull/65)).
      - **Optional prices** - Product model allows absent price data without breaking transforms ([#61](https://github.com/adobe-commerce/storefront-pdp/pull/61)).
...
*********************/}
    ...
    >
      ...
      - **Pathname with store code** - Category and search path detection handles store codes in the pathname, including quick search ([#88](https://github.com/adobe-commerce/storefront-search-dropin/pull/88), [#91](https://github.com/adobe-commerce/storefront-search-dropin/pull/91)).
      - **Elsie 1.8.0** - Updated to `@adobe-commerce/elsie` 1.8.0.
...
**************************/}
    ...
    >
      ...
      - **Elsie 1.8.0** - Updated to `@adobe-commerce/elsie` 1.8.0. No user-facing changes in this release.
...
************/}
    ...
    >
      ...
      - **Multi-store support** - Storage keys and cookies scope per store view when `storeCode` is set, isolating wishlist data between stores ([#73](https://github.com/adobe-commerce/storefront-wishlist/pull/73)).
      - **`langDefinitions` merge** - Custom language definitions merge with bundled defaults ([#79](https://github.com/adobe-commerce/storefront-wishlist/pull/79)).
      - **Elsie 1.8.0** - Updated to `@adobe-commerce/elsie` 1.8.0.
...
****************/}
    ...
    >
      ...
      - **Order date and time** - `orderTime` on order models and `OrdersListOrderTime` slot for orders list cards ([#45](https://github.com/adobe-commerce/storefront-account/pull/45)).
      - **CustomerOrder fragment extension** - GraphQL fragments support `overrideGQLOperations` extensions ([#46](https://github.com/adobe-commerce/storefront-account/pull/46)).
      - **Elsie 1.8.0** - Updated to `@adobe-commerce/elsie` 1.8.0.
...
*************/}
    ...
    >
      ...
      - **Container slots** - Title, form, and button sections expose slots across sign-in, sign-up, reset password, and update password flows ([#58](https://github.com/adobe-commerce/storefront-auth/pull/58)).
      - **Reset Password slots** - Missing slot props on Reset Password containers are fixed ([#64](https://github.com/adobe-commerce/storefront-auth/pull/64)).
      - **Elsie 1.8.0** - Updated to `@adobe-commerce/elsie` 1.8.0.
...
**********************/}
    ...
    >
      ...
      - **Initializer alignment** - Initializer matches the pattern used by other drop-ins ([#77](https://github.com/adobe-commerce/storefront-company-management/pull/77)).
      - **`langDefinitions` merge** - Custom language definitions merge with bundled defaults ([#76](https://github.com/adobe-commerce/storefront-company-management/pull/76)).
      - **Elsie 1.8.0** - Updated to `@adobe-commerce/elsie` 1.8.0.
...
******************/}
    ...
    >
      **Initial stable release** of the Quick Order drop-in for B2B bulk ordering. Highlights include:

      - **Quick Order Variants Grid** - `QuickOrderVariantsGrid` container for variant-based quick order flows ([#21](https://github.com/adobe-commerce/storefront-quick-order/pull/21)).
      - **`langDefinitions` merge** - Custom language definitions merge with bundled defaults ([#23](https://github.com/adobe-commerce/storefront-quick-order/pull/23)).
      - **Boilerplate integration** - B2B boilerplate adds `@dropins/storefront-quick-order@~1.0.0` ([#1156](https://github.com/hlxsites/aem-boilerplate-commerce/pull/1156)).
...
********************/}
    ...
    >
      ...
      - **`langDefinitions` merge** - Custom language definitions merge with bundled defaults ([#89](https://github.com/adobe-commerce/storefront-quote-management/pull/89)).
      - **Elsie 1.8.0** - Updated to `@adobe-commerce/elsie` 1.8.0.
...
*********************/}
    ...
    >
      ...
      - **Catalog integration props** - Catalog data is supplied through injected props instead of internal API catalog helpers ([#114](https://github.com/adobe-commerce/storefront-requisition-list/pull/114)).
      - **`langDefinitions` merge** - Custom language definitions merge with bundled defaults ([#124](https://github.com/adobe-commerce/storefront-requisition-list/pull/124)).
      - **Elsie 1.8.0** - Updated to `@adobe-commerce/elsie` 1.8.0.
