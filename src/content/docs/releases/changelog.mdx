...
***************/}
    ...
    >
      The Commerce boilerplate has been updated with incremental enhancements building on the January 2026 release:

      **Breaking changes:**

      - **Node.js 24 required** - The boilerplate now requires Node.js 24. Update your development environment before upgrading.
      ...
      **Document Authoring improvements:**
      ...
      - **Improved field naming** - Block field definitions now use semantic names (e.g., `image`, `text`, `summary`) instead of CSS selector-based names ([#1086](https://github.com/hlxsites/aem-boilerplate-commerce/pull/1086)).
      ...
      **Infrastructure updates:**
      ...
      - **ESLint configuration** - Added `*.min.js` to ESLint ignore patterns for minified files ([#580](https://github.com/hlxsites/aem-boilerplate-commerce/pull/580)).
      ...
      **Improvements and fixes:**
      ...
      - **Header null safety** - Navigation sections now include null checks preventing errors when sections are missing ([#581](https://github.com/hlxsites/aem-boilerplate-commerce/pull/581)).
...
*****************/}
    ...
    >
      The Drop-in SDK (Elsie) has been updated with incremental improvements to support the February 2026 drop-in component releases. This release primarily includes internal optimizations and dependency updates.
...
************/}
    ...
    >
      ...
      - **SDK and dependency updates** - Updated event bus package and SDK components for improved stability and compatibility with the February 2026 suite.
...
**********************/}
    ...
    >
      ...
      - **SDK and dependency updates** - Updated SDK components for improved stability and compatibility with the February 2026 suite.
...
********************/}
    ...
    >
      ...
      - **SDK and dependency updates** - Updated SDK components for improved context switching functionality and compatibility with the February 2026 suite.
...
******************/}
    ...
    >
      ...
      - **SDK and dependency updates** - Upgraded event-bus package and SDK components for improved procurement workflow functionality.
...
*********************/}
    ...
    >
      ...
      - **SDK and dependency updates** - Upgraded event-bus package and SDK components for improved list management functionality.
