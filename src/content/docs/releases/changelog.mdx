...
***************/}
    ...
    >
      ...
      **Infrastructure**
      - **Drop-in SDK upgraded to 1.8.1**: `@dropins/tools` updated to 1.8.1, which includes `@adobe-commerce/elsie` 1.8.1 and `@adobe-commerce/recaptcha` 1.1.0.
