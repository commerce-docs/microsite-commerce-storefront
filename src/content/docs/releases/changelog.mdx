...
*********/}
    ...
    >
      ...
      - **Multi-store GraphQL ready**: Configuration now supports Magento store code headers when the MAGENTO_STORE_CODE environment variable is set, enabling multi-store operations.
