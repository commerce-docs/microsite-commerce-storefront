...
************************************/}
      ...
      >
          ...
          - **Requisition List**: Introduced Requisition List Sharing feature for B2B customers, enabling Requisition lists to be shared via link or email with read-only access and import capability, while maintaining backward compatibility.
      </ChangelogEntry>
