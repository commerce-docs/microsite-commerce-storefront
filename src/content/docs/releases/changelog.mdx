...
************/}
    ...
    >
      ...
      - **`BillToShippingAddressProps.onError` property added**: This property allows performing some actions in case of an error is thrown when the bill to shipping checkbox is checked.
