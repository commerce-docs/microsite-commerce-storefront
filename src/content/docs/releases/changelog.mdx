...
************************************/}
    ...
    >
      ...
      >
          ...
          - **Negotiable Quote Templates**: Delivered multiple stability and consistency improvements across template mutations and GraphQL responses. This includes resolving server errors, correcting validation issues related to item IDs and quantities, aligning input types with ACCS (including UID support), adding missing field-level resolvers for consistent data exposure, and introducing support for setting expiration dates.

          - **Negotiable Quote**: Added missing GraphQL fields such as creator_name and Minimum Order Total configuration attributes, and resolved an internal server error when requesting the status field in the getNegotiableQuotes query.
      ...
      >
          ...
          - **Negotiable Quote Templates**: Added the new historyV2 field to support enhanced Negotiable Quote Template history.
