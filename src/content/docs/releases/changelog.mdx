...
************************************/}
    ...
    >
      ...
      >
          ...
          - **Negotiable Quote Templates**: Resolved an issue causing the negotiableQuoteTemplates GraphQL query to return null and a server error instead of valid negotiable quote template data.
      </ChangelogEntry>
      ...
      >
          ...
          - **Purchase Orders**: Introduced a new my_approvals Boolean field in the PurchaseOrdersFilterInput GraphQL input type. This field filters purchase orders pending or completed for the customer’s approval, aligning with the “Require My Approval” tab behavior in Luma.

          - **Company Users**: Updated the Company User creation process via GraphQL by making the job_title and telephone fields optional.
      </ChangelogEntry>
