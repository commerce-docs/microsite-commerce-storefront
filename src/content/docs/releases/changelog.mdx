...
***************/}
    ...
    <Aside type="note" title="Internal Links">
      Most of the links in the October 2025 suite resolve to private repos. If you do not have access to these private repos (drop-in repos), the links will not resolve.
    </Aside>
...
********************/}
    ...
    >
      ...
      - **Now uses public npm registry**: Package dependencies have moved from Adobe internal Artifactory to the public npm registry (@adobe-commerce scope), improving accessibility and simplifying installation ([#1](https://github.com/adobe-commerce/storefront-payment-services/pull/1), [#2](https://github.com/adobe-commerce/storefront-payment-services/pull/2)).
      ...
      - **Better guest cart handling**: Cart creation now uses the createGuestCart mutation instead of createEmptyCart for proper guest session handling and improved error messaging ([#3](https://github.com/adobe-commerce/storefront-payment-services/pull/3)).
