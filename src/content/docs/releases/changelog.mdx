...
************************************/}
      ...
      <ChangelogEntry
          date="2025-10-08"
          title="Storefront Compatibility Package v4.8.8, v4.7.11"
      ...
      >
          ...
          **4.8.8:**
          - **Customer ID**: GraphQL API Customer.id field deprecation is removed, and returns the correct value that can be reused for B2B company management GraphQL mutations/queries.
          - **Negotiable Quote Address**: Aligned multiple address input types to support customer address UID, deprecating customer address ID. Introduced deleteCustomerAddressV2 and updateCustomerAddressV2 mutations and deprecated the previous versions.
          **4.7.11:**
          - **Negotiable Quote Address**: Aligned multiple address input types to support customer address UID, deprecating customer address ID. Introduced deleteCustomerAddressV2 and updateCustomerAddressV2 mutations and deprecated the previous versions.
      </ChangelogEntry>
     <ChangelogEntry
