...
slug: boilerplate/customizing-blocks
sidebar:
...
1. Check the [Blocks reference](/boilerplate/blocks-reference/) for the full list of blocks, their drop-ins, and page-type groupings.
