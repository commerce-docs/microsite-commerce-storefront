...
* [ ] Confirm that your authoring source is document-based or Universal Editor (and configured correctly). For Universal Editor in the Commerce boilerplate, see [Blocks and the Universal Editor](/blocks/universal-editor/).
...
* [ ] Confirm that storefront branding matches your CSS design tokens, typography, and colors. See [Customize blocks](/blocks/customize-blocks/).
</Checklist>
