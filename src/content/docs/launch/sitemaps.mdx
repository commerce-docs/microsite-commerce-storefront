...
Each sitemap file has a maximum URL count and uncompressed file size. If your catalog exceeds those limits, split the sitemap into multiple files and reference all of them in your `sitemap-index.xml` and `robots.txt`. See <Link href="https://www.aem.live/docs/limits#sitemap-limits" text="Sitemap limits on AEM.live" /> for details.
</Aside>
