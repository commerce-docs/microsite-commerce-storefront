...
1. **Select a starter kit** — Choose **AEM Boilerplate Commerce**. This tells the installer which skill set and conventions to copy into your project (other starter kits may be added in the future).
