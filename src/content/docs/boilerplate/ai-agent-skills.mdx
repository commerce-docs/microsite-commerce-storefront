...
- **An AEM Boilerplate Commerce project** — The skills are designed for projects based on the <Link href="https://github.com/hlxsites/aem-boilerplate-commerce" text="Commerce Boilerplate" />. See [Getting started](/boilerplate/getting-started/) if you need to create one first.
