...
<Aside type="tip" title="Commerce on Cloud or on-premises">
Coordinate Commerce compatibility package upgrades with npm and boilerplate changes on this page. For B2B drop-ins, see [Storefront Compatibility B2B Package](/setup/configuration/storefront-compatibility/b2b/) and [Manual installation](/setup/configuration/storefront-compatibility/install/#install-the-b2b-package).
</Aside>
...
- [How the Storefront Works](/get-started/architecture/): Understanding the technical foundation
