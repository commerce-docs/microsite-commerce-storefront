...
4. Test with demo backend or configure your own in `config.json` (copy from [demo config](https://main--aem-boilerplate-commerce--hlxsites.aem.live/config.json) or use the [config generator tool](https://da.live/app/adobe-commerce/storefront-tools/tools/config-generator/config-generator))
