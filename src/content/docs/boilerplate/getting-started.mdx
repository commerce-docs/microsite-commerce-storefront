...
- `scripts/aem.js` — The core AEM runtime. Pulled verbatim from the upstream [AEM Boilerplate](https://github.com/adobe/aem-boilerplate); any local edit will conflict on the next sync.
