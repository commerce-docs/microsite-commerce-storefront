...
slug: setup/configuration/cors-setup
---
...
- **Server configuration**: Configure CORS headers at the web server level (<Link href={"https://enable-cors.org/server_nginx.html"} text={"Nginx"} />, <Link href={"https://enable-cors.org/server_apache.html"} text={"Apache"} />)
- **Third-party module**: Use a community module such as <Link href={"https://github.com/graycoreio/magento2-cors"} text={"graycore/magento2-cors"} />
