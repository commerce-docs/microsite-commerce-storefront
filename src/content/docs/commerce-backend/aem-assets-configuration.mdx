...
slug: setup/configuration/aem-assets-configuration
---
...
The Commerce drop-ins automatically detect the `commerce-assets-enabled` configuration and adjust image handling accordingly. See the <Link href={"https://www.aemshop.net/config.json"} text={"demo configuration"} />. 
...
See the <Link href={"https://github.com/hlxsites/aem-boilerplate-commerce"} text={"Commerce Boilerplate"} /> for complete examples.
</Aside>
...
1. For more details, see [Commerce drop-ins overview](/dropins/all/introduction/).
...
<Aside type="tip" title="AEM Assets API helpers">
...
2. **Check config location:** Verify your <Link href={"https://experienceleague.adobe.com/developer/commerce/storefront/setup/configuration/commerce-configuration/"} text={"storefront configuration"} /> is properly formatted.
