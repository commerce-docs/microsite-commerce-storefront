...
slug: setup/configuration/gated-content
---
...
You can [download a sample solution](/samples/fastly-compute-sample.zip) that provides an outline of how to implement gated content using Fastly Compute. This sample is based on Fastly's <Link href={"https://www.fastly.com/documentation/solutions/starters/compute-starter-kit-javascript-default/"} text={"Default starter kit for JavaScript"} />.
