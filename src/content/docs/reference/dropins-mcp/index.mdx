...
For installation and editor configuration, see [Dropins MCP](/get-started/dropins-mcp/). For connection and configuration troubleshooting, see [Dropins MCP FAQ](/troubleshooting/faq/#dropins-mcp).
