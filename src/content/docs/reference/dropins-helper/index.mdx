---
title: Drop-in helper reference
description: All 20 tools available in the drop-in helper, grouped by category, with parameters and usage examples.
tableOfContents:
  maxHeadingLevel: 3
---
...
For installation and editor configuration, see [Drop-in helper](/ai/dropins-helper/). For connection and configuration troubleshooting, see [Drop-in helper FAQ](/troubleshooting/faq/#drop-in-helper).
...
**Example:** _"Use the drop-in helper to analyze my project at /Users/me/my-storefront"_
