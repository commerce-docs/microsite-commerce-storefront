...
For more information on GitHub Templates, you can refer to the following resource: <Link href={"https://docs.github.com/en/repositories/creating-and-managing-repositories/creating-a-repository-from-a-template"} text={"How to Use GitHub Repository Templates"} />.
...
:::tip[More Info]
For more details on _Elsie CLI_ commands and their usage, visit this documentation page: <Link href={"https://experienceleague.adobe.com/developer/commerce/storefront/sdk/get-started/cli/"} text={"Elsie CLI"} />.
:::
</Task>
...
- <Link href={"https://jestjs.io/docs/getting-started"} text={"Jest Getting Started (official docs)"} />
- <Link href={"https://testing-library.com/docs/preact-testing-library/intro"} text={"Preact Testing Library Intro"} />
...
<Link href={"https://storybook.js.org/docs"} text={"Here"} /> is the official Storybook documentation.
...
:::tip[More Info]
For more details on the usage of _event bus_, _initializers_, and _render_, visit this documentation page: <Link href={"https://experienceleague.adobe.com/developer/commerce/storefront/sdk/reference/"} text={"SDK documentation"} />.
:::
