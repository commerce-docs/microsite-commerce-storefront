...
:::tip[More Info]
For more details on _Elsie CLI_ commands and their usage, visit this documentation page: <Link href={"/sdk/get-started/cli/"} text={"Elsie CLI"} />.
:::
</Task>
...
:::tip[More Info]
For more details on the usage of _event bus_, _initializers_, and _render_, visit this documentation page: <Link href={"/sdk/reference/"} text={"SDK documentation"} />.
:::
