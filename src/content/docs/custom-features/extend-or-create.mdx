...
slug: dropins/all/extend-or-create
---
...
<Aside type="tip" title="Need new UI without a new drop-in?">
If existing drop-ins don't cover a feature but you don't want to own a whole new drop-in package, see [Build custom features](/blocks/build-custom-features/) — a lighter-weight pattern that combines an existing drop-in's API function, shared SDK components, and the event bus inside a custom commerce block.
</Aside>
