...
<Aside type="note" title="PLP breadcrumbs and prerendering">
  ...
  If your <Link href="https://www.aem.live/developer/byom" text="Bring Your Own Markup (BYOM)" /> solution doesn't render category listing pages, continue authoring the PLP's `<ol>` by hand (see [Step 2](#step-2-add-breadcrumbs-to-a-plp-and-a-pdp) above), or generate it with your own tooling.
</Aside>
