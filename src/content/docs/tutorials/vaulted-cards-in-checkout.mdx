---
slug: dropins/payment-services/tutorials/vaulted-cards-in-checkout
...
This tutorial requires installing pre-release versions of `@dropins/storefront-checkout` and `@dropins/storefront-payment-services`, not the default dependencies that the boilerplate ships with today. Vaulting functionality is provided in this version of the Payment Services drop-in.
</Aside>
