...
* [ ] Switch to the Catalog Service production endpoint (`https://catalog-service.adobe.io/graphql`). For how Adobe Commerce exposes and secures the service, see the <Link href={"https://experienceleague.adobe.com/en/docs/commerce/catalog-service/installation#access-the-service"} text={"Catalog Service installation guide"} /> on Experience League.
