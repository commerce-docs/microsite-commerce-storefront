...
* [ ] When using Adobe Commerce Fastly, request a new CDN purge token for Commerce production
      ...
      `serviceId`).
* [ ] Validate your [CDN configuration](/storefront-setup/configuration/content-delivery-network/) and ensure that caching
...
* [ ] Ensure that your product detail pages have [metadata and structured data](/storefront-setup/seo/metadata/)
