...
* [ ] If you use Adobe Commerce Optimizer, confirm `adobe-commerce-optimizer` is set to `true`, `commerce-endpoint` points to the production Optimizer GraphQL endpoint, and the `AC-View-ID` header holds the catalog view ID for your production instance. See [Commerce configuration](/setup/configuration/commerce-configuration/).
