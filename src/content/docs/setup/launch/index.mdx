...
* [ ] Verify that you have configured permissions for DA content and EDS sites. See <Link href={"https://da.live/docs/administration/permissions"} text={"DA.live permissions"} /> and <Link href={"https://www.aem.live/docs/authentication-setup-authoring"} text={"authentication setup for authoring"} />.
* [ ] Ensure that the product visuals integration has been provisioned. See <Link href={"https://experienceleague.adobe.com/en/docs/experience-manager-learn/cloud-service/accessing/overview#"} text={"AEM Cloud Service access overview"} />.
...
* [ ] Request a new CDN purge token for your Adobe Commerce production environment when using Adobe Commerce Fastly. Then update your <Link href={"https://tools.aem.live/tools/cdn-setup/index.html"} text={"site configuration"} /> by adding the authToken and serviceId values.
...
For complete documentation on launching your storefront, visit the <Link href={"https://www.aem.live/docs/#launch"} text={"Launch section"} /> on the Adobe Experience Manager site or select the direct links below. You should also review the Commerce-specific [launch checklist](#launch-checklist).

<TableWrapper nowrap={[0]}>

| Topic | Description |
| ----- | ----------- |
| <Link href={"https://www.aem.live/docs/go-live-checklist"} text={"Go-Live Checklist"} /> | Summary of best practices to consider when launching a website. |
...
| <Link href={"https://www.aem.live/docs/byo-cdn-cloudflare-worker-setup"} text={"Cloudflare Worker Setup"} /> | Configure Cloudflare to deliver content. |
| <Link href={"https://www.aem.live/docs/byo-cdn-akamai-setup"} text={"Akamai Setup"} /> | Use the Akamai Property Manager to configure a property to deliver content. |
| <Link href={"https://www.aem.live/docs/byo-cdn-fastly-setup"} text={"Fastly Setup"} /> | Configure Fastly to deliver content. |
| <Link href={"https://www.aem.live/docs/byo-cdn-cloudfront-setup"} text={"CloudFront Setup"} /> | Set up Amazon Web Services CloudFront to deliver your AEM site with push invalidation. |
