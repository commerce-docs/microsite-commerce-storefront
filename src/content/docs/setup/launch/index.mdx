...
1. [Redirects](https://www.aem.live/docs/redirects): You can intuitively manage redirects as a spreadsheet called redirects (or `redirects` document) in the root of your project folder.
