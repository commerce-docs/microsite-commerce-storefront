...
Adobe provides these launch resources to help ensure a smooth and successful storefront launch because launching a storefront requires more than a simple CDN switch. Ensure that launch activities are well defined and planned, and prepare a rollback plan in case you encounter issues.

## Launch checklist

Complete all pre-work and tasks required to launch a new storefront can be overwhelming. This checklist helps ensure you complete and track all necessary work before going live.
