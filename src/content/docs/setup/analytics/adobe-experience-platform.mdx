...
| `eventForwardingContext.commerce` | Enables commerce event tracking | Yes |
...
- **`eventForwardingContext.commerce: true`**: Enables tracking of commerce-specific events like product views, cart additions, and purchases
...
- **Product interactions**: Views, clicks, add-to-cart actions
- **Shopping behavior**: Cart updates, checkout steps, purchases
- **User engagement**: Page views, time on site, navigation patterns
...
For a complete implementation example, see the <Link href="https://experienceleague.adobe.com/docs/core-services/interface/administration/organizations.html" text="Organizations documentation" /> [AEM Commerce Boilerplate integration](https://github.com/hlxsites/aem-boilerplate-commerce).
