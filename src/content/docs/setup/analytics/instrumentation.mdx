...
To configure variables for your Commerce backend, you must update the `analytics` object located in either your site config or a `config.json` in your repository. It should resemble the `analytics` property on https://aemshop.net/config.json.
