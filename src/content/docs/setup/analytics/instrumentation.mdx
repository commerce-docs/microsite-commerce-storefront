...
- **Search events**: NOTE: **If LiveSearch is not installed and configured, these search events are not sent:** Search query (`searchRequestSent`) and search results (`searchResponseReceived`).
