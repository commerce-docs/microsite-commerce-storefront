...
- Added a new action parameter has been added to confirmation links in order to identify if the request is for order cancellation or order return confirmation.
