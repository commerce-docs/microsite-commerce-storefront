...
Most of these changes enhance the Adobe Commerce GraphQL schema. However, miscellaneous bugfixes are also included. The dropin-in components require this package.
