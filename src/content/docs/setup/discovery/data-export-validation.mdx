...
Data export synchronizes data between an Adobe Commerce instance and connected [storefront services](/get-started/architecture/#storefront-services). Storefront services are required for drop-in components to work correctly.
