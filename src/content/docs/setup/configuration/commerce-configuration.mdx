...
For where the configuration file lives and how it's structured, see [Storefront configuration](/setup/configuration/commerce-configuration/). The examples below illustrate typical values only.
