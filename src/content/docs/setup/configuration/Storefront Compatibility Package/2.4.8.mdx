...
:::note[Note]
This Storefront Compatibility Package can be installed on Adobe Commerce 2.4.8 only. Fixes in this package will be included automatically in the upcoming release of Adobe Commerce 2.4.9. Lower versions of Adobe Commerce are not supported. Magento Open Source is not supported.
:::
