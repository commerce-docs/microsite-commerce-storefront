...
:::note[Note]
This Storefront Compatibility Package can be installed on Adobe Commerce 2.4.7 only. It is included automatically in Adobe Commerce 2.4.8. Lower versions of Adobe Commerce are not supported. Magento Open Source is not supported.
:::
