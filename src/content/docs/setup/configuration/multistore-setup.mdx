...
3. **Use automated translation tools**: For guidance on using da.live's Translation app to automate content translation, see [Content localization](/merchants/quick-start/content-localization/).
</Steps>
