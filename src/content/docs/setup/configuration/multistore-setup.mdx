...
1. **Translate content files** in the `/en-ca/` and `/fr-ca/` folders using your chosen authoring tool:
   ...
   - **Universal Editor** (AEM Sites Authoring projects only): Follow the [Localization (Universal Editor)](/merchants/quick-start/content-localization-universal-editor/) workflow
