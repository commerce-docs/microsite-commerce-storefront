...
1. **Translate content files** in the `/en-ca/` and `/fr-ca/` folders using your chosen authoring tool:
   - **Document Authoring**: Follow the [da.live Translation app workflow](/merchants/quick-start/content-localization/)
   - **Universal Editor**: Follow the [AEM translation workflow](/merchants/quick-start/content-localization-universal-editor/)
