...
**Recommended format:** Use hyphens for locale folders (`en-ca`, `fr-ca`) as they align with web URL conventions and are used throughout this documentation.

While underscores (`en_ca`) also work, choose one format and use it consistently across all store views. Ensure folder names match exactly with Adobe Commerce store view codes and can be used in web addresses.
