...
If using a CORS module with admin UI configuration (such as [graycore/magento2-cors](https://github.com/graycoreio/magento2-cors)), navigate to **Stores** → **Configuration** → **General** → **Web** → **CORS Whitelist** in the Adobe Commerce admin panel.
