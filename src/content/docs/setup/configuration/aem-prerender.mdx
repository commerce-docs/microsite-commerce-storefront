...
flowchart LR
    ...
    Step4["<strong>4. Integrate with Your Storefront</strong><br/>Repository: Your Commerce Boilerplate<br/>Modify product-details block to use prerendered markup"]:::repo2
...
- **Product not rendering**: Check that the product exists in Catalog Service and the SKU matches
  - Query Catalog Service directly using its <Link href="https://developer.adobe.com/commerce/services/graphql/catalog-service/products/" text="GraphQL Product API" /> to verify product data
