...
- **Product not rendering**: Check that the product exists in Catalog Service and that the SKU matches
  ...
  - Run `aio rt activations list` to check action logs. For more details, see the <Link href="https://github.com/adobe-rnd/aem-commerce-prerender/blob/main/docs/RUNBOOK.md" text="runbook" />
...
- **Markup not updating**: Review the Change Detector logs to ensure scheduled triggers are running
  ...
  - Run `aio rt activations list` to check activation logs. For more details, see the <Link href="https://github.com/adobe-rnd/aem-commerce-prerender/blob/main/docs/RUNBOOK.md" text="runbook" />
