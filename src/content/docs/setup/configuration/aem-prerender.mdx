...
If your catalog or requirements run into these limits — an unusually large category, a need for near-real-time updates, or per-category overrides — work with your development team on a custom approach for those pages.

{/* TODO(USF-4304): link to guidance on per-SKU/per-category content overrides once available */}
