...
Prerender is one way to server-side render catalog pages on Edge Delivery Services. Not every product or category page needs it — see [SSR and crawlability](/setup/seo/ssr-and-crawlability/) for how to use Google Search Console crawl-demand data, rather than SKU count, to decide which pages benefit from server-side rendering.
</Aside>
