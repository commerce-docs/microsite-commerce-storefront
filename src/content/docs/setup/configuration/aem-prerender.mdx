...
<Aside type="tip" title="Deciding what to prerender">
Not every product or category page needs prerendering. See [SSR and crawlability](/setup/seo/ssr-and-crawlability/) for how to use Google Search Console crawl-demand data, rather than SKU count, to decide which pages benefit from it.
</Aside>
