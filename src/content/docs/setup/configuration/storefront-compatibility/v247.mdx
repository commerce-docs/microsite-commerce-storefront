...
- [`guestOrder`](https://developer.adobe.com/commerce/webapi/graphql/schema/orders/queries/guest-order/) query - Retrieves guest order information for the specified order number, email, and billing last name.

- [`guestOrderByToken`](https://developer.adobe.com/commerce/webapi/graphql/schema/orders/queries/guest-order-by-token/) query - Retrieves guest order data associated with a given order token.
