...
- `deleteCustomerAddressV2` mutation - Delete the billing or shipping address of a customer using customer UID as input.

- `updateCustomerAddressV2` mutation - Update the billing or shipping address of a customer using customer UID as input.
