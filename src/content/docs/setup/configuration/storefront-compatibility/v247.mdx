...
- [`guestOrder`](https://developer.adobe.com/commerce/webapi/graphql/schema/orders/queries/guest-order/) query - Retrieves information about a guest order using an order number, email, and billing last name as input.

- [`guestOrderByToken`](https://developer.adobe.com/commerce/webapi/graphql/schema/orders/queries/guest-order-by-token/) query - Retrieves information about a guest order based on an order token.
