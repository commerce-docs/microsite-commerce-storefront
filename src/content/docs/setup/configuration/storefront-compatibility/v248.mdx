...
- [`deleteCustomerAddressV2`](https://developer.adobe.com/commerce/webapi/graphql/schema/customer/mutations/delete-address-v2) mutation - Deletes a billing or shipping address of a customer using customer UID as input.
...
- [`updateCustomerAddressV2`](https://developer.adobe.com/commerce/webapi/graphql/schema/customer/mutations/update-address-v2) mutation - Updates a billing or shipping address of a customer using customer UID as input.
