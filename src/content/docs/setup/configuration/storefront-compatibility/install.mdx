...
:::note[Note]
You must have Adobe Commerce 2.4.7 or 2.4.8 or 2.4.9 installed. Magento Open Source is not supported.
:::
...
Use this method to install the Storefront Compatibility Package using the Cloud infrastructure.
    ...
    1. Add the Storefront Compatibility module.
       ...
       For Adobe Commerce 2.4.9, run: <Badge tooltip="Applies to Adobe Commerce as a Cloud Service and Adobe Commerce Optimizer projects only (Adobe-managed SaaS infrastructure)." text="PaaS + ACO only" variant="success" href="https://experienceleague.adobe.com/en/docs/commerce/user-guides/product-solutions" />
