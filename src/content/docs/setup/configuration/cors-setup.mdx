...
- **Third-party modules**: Refer to the module's documentation (e.g., [graycore/magento2-cors configuration](https://github.com/graycoreio/magento2-cors#configuration))
