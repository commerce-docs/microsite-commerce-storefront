...
:::note[Note]
The Storefront Compatibility Package 4.8 can be installed on Adobe Commerce 2.4.8 only. It is included automatically in Adobe Commerce 2.4.9. The Storefront Compatibility Package 4.7 is compatible exclusively with Adobe Commerce 2.4.7 and Lower versions of Adobe Commerce are not supported. Magento Open Source is not supported.
:::
