---
title: Storefront Compatibility Package (4.7)
...
The Storefront Compatibility Package 4.7 contains changes to the Adobe Commerce 2.4.7 codebase that enable drop-in component functionality.
...
:::note[Note]
The Storefront Compatibility Package 4.7 can be installed on Adobe Commerce 2.4.7 only. It is included automatically in Adobe Commerce 2.4.8. Lower versions of Adobe Commerce are not supported. Magento Open Source is not supported.
:::
...
Use this method to install the Storefront Compatibility Package using the Cloud infrastructure.
    ...
    1. Add the Storefront Compatibility module.
       ...
       ```bash
       composer require adobe-commerce/storefront-compatibility:<version>
       ```
