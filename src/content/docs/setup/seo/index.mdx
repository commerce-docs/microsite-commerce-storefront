...
- [SSR and crawlability](/setup/seo/ssr-and-crawlability/) — use Google Search Console crawl-demand data, not SKU count, to decide which pages need server-side rendering.
