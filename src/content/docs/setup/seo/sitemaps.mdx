...
Add a `Sitemap` directive to your `robots.txt` file so crawlers discover it automatically. If your project doesn't have a `robots.txt` yet, create one in the repository root.
