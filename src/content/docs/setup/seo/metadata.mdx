...
**Metadata Generation**: Metadata applied through <Link href={"https://www.aem.live/docs/bulk-metadata"} text={"bulk metadata"} /> only applies metadata for lowercase URLs. The PDP Metadata Generation tool has been updated to produce output in the correct format.
