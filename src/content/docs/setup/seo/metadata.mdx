...
The boilerplate will enforce lowercase SKUs for all product URL links out of the box. This is due to a requirement in Edge Delivery Services which does not support uppercase paths.
