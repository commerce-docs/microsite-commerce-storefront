...
:::note
The Commerce boilerplate now enforces lowercase SKUs in all product URLs for improved SEO and consistency. This change affects how product links are generated and requires attention for sites with uppercase SKUs.
...
- See the [metadata documentation](/setup/seo/metadata/#static-site-generation-ssg-metadata-support) for implementation details
:::
