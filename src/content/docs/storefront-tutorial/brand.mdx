---
title: Brand dropins with tokens
...
Design tokens! You'll learn how to override the **Commerce design token values** to match your brand colors, typography, spacing, shapes, and layouts. But first, let's define the vocabulary and concepts required to understand this process.
