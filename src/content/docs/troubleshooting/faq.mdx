...
This could be due to either <Link href="https://docs.da.live/administrators/guides/permissions" text="DA permissions" /> or Site Permissions. For Site Permissions, see the User Admin page of the <Link href="https://tools.aem.live/tools/user-admin/index.html?org=adobe-commerce&site=frescopa" text="tools.aem.live" /> guide.
