...
import previewImage from './images/cartitem.webp';
...
<ComponentPreview src={previewImage} alt="The SDK CartItem showing a product line with image, title, price, and quantity control." />
