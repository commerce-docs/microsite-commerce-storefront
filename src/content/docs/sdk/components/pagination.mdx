...
import previewImage from './images/pagination.webp';
...
<ComponentPreview src={previewImage} alt="The SDK Pagination showing previous, next, and numbered page controls." />
