...
import previewImage from './images/incrementer.webp';
...
<ComponentPreview src={previewImage} alt="The SDK Incrementer showing a numeric value with increase and decrease buttons." />
