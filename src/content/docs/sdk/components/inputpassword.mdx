...
import previewImage from './images/inputpassword.webp';
...
<ComponentPreview src={previewImage} alt="The SDK InputPassword showing a password field with a show and hide toggle." />
...
| `placeholder` | `string` | No | Placeholder text. Defaults to 'Password'. |
| `floatingLabel` | `string` | No | Label text that floats above the field. Defaults to 'Password'. |
