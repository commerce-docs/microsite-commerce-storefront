---
title: debounce
description: Use the debounce utility in the Adobe Commerce Storefront SDK to limit how often a function runs so cart, search, and PDP handlers stay responsive under rapid user input.
---
