---
title: Storefront SDK introduction
description: The Storefront SDK is a set of tools and resources that help you build and customize your storefront with drop-in components.
---
