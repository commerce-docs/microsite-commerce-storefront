---
title: VComponent
description: Understand the VComponent wrapper for dynamic rendering in the Adobe Commerce Storefront SDK when you need flexible VNode trees inside drop-in containers.
---
