---
title: Render
description: Render Adobe Commerce Storefront SDK components to the DOM or as HTML strings, including patterns for mounting drop-ins and integrating with your host application.
---
