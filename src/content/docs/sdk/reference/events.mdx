...
Execute the event handler immediately with the last known payload when subscribing. This feature is useful for getting the current state without waiting for the next event.
