---
title: Event Bus
description: Use the Storefront SDK event bus to communicate between Adobe Commerce drop-in packages, subscribe to lifecycle events, and keep cart, checkout, and PDP flows in sync.
---
