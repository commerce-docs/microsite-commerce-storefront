---
title: Overview
description: Explore the Adobe Base design system for storefront SDK work, including tokens for color, typography, spacing, shapes, and grids that keep drop-in UIs consistent.
---
