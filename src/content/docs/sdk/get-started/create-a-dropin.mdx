...
Run the following command, replacing `<Domain>` with the name of the frontend project you're building (e.g., `Login`):
...
**Tip:**  
Open `src/components/` to start building your UI.
</Task>
...
Full details about API function development will be provided soon. For now, review the files generated in `src/api/`.
</Task>
...
Full details about container development will be provided soon. For now, review the files generated in `src/containers/`.
</Task>
