...
Welcome to the new Adobe Commerce Storefront! We're here to give you the most information and pleasure with the least effort and time. We'll start each topic with big-picture overviews and end with hands-on learning to make your storefront journey as informative and fun as possible.

## Big picture

Before you start your timers, let's preview the steps you'll take to create and configure your storefront:
...
Before we dive into the step-by-step guide, let's review some key concepts that will help you understand the process of creating and configuring your storefront.
...
The Code Sync app listens to changes in your code repositories and publishes code to the Edge Delivery code bus. It also intelligently purges CDN caches when changes have been made. This app is essential for keeping your storefront up-to-date with the latest changes.

### Content folder

The content folder is where you store all the content for your storefront. This includes images, text, and other assets that make up your site. By sharing your content folder with the Edge Delivery system, you enable it to provide all the features of document-based authoring, such as editing, previewing, and publishing.
...
The local development environment is where you develop and test your storefront before deploying it to production. It's a self-contained environment that allows you to experiment with different configurations and settings without affecting the live site.

### Mountpoint

The mountpoint is the URL that points to your content folder on Google Drive or SharePoint. By specifying the mountpoint in your GitHub repo's **fstab.yaml** file, you tell the Edge Delivery system where to find the content for your storefront.

</Concepts>

## Examples

Let's take a look at some existing storefronts created using Edge Delivery Services + Commerce.



## Step-by-step

The star of this **20-minute storefront** is our Commerce boilerplate template. It provides a starter storefront that is pre-configured with our Commerce components and services and pre-connected to our Commerce boilerplate backend.
...
<Tabs>
  ...
  <TabItem label="SharePoint">
    ...
    1. Open your [SharePoint Home](https://adobe.sharepoint.com/SitePages/Home.aspx) page, select the ![create button](images/create-button.svg) **Create** button, then select **Site** from the menu.
...
<Tabs>
  ...
  <TabItem label="SharePoint">
    ...
    <Diagram caption="Add sample SharePoint content.">
      ![Add sample SharePoint content.](images/add-sp-content.webp)
    </Diagram>
...
Watch this video to see the steps to create and configure your Commerce storefront.

## Playground

Explore the [Commerce Playground]() to see the Commerce storefront in action.
