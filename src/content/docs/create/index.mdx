...
<Tabs>
  <TabItem label="Google Drive">
    ...
    <Diagram width="494px" caption="Add sample Google Drive content.">
  ...
  <TabItem label="SharePoint">
    ...
    <Diagram width="494px" caption="Add sample SharePoint content.">
      ![Add sample SharePoint content.](@assets/create/add-sp-content.png)
    </Diagram>
...
In this step, we'll connect the code in your GitHub repo to the content in your Google Drive or SharePoint folder. This connection allows Edge Delivery to coordinate code changes with content changes, so your storefront stays up-to-date with all the latest changes from both sides (code and content).

1. Copy the **Content URL** from your Google Drive folder or the **Link** from your SharePoint folder.
1. Go to your GitHub repo and open the `fstab.yaml` file.
1. Replace the `mountpoints` URL with the URL you copied from your Google Drive folder or SharePoint link.
...
1. Commit the changes to your repo.
   ...
   ```bash frame="none"
    git add fstab.yaml
    git commit -m "Add link to content folder"
