...
<Tabs>
  <TabItem label="SharePoint">
    <Aside type="tip">
      For SharePoint users, the quickest way to copy sample content to your folder is from within SharePoint as described here.
      You can also download the [starter-content-commerce.zip](https://github.com/hlxsites/aem-boilerplate-commerce/releases/download/starter-content/starter-content-commerce.zip) from the boilerplate repo and drag it in.
    </Aside>

    <Diagram width="494px" caption="Add sample SharePoint content.">
      ![Share your content folder.](@assets/create/add-sp-content.png)
    </Diagram>
  ...
  <TabItem label="Google Drive">
    <Aside type="tip" title="Google Drive folder setup">
      Ensure that **Uploads** are enabled in Google Drive. If enabled, your shared folder converts SharePoint files (Word and Excel) to Google Docs and Sheets.

      Open your shared Google Drive folder, select the ⚙️ Settings icon at the top right, choose the **Settings** menu option, and enable the **Uploads** checkbox. Then exit Settings.
    </Aside>

    1. Download the [starter-content-commerce.zip](https://github.com/hlxsites/aem-boilerplate-commerce/releases/download/starter-content/starter-content-commerce.zip) to your computer and unzip it.

    1. Open the folder, select all the content, and drag it into your shared Google Drive folder. This will convert the Word and Excel files to Google Docs and Sheets.
