...
Welcome to the new Adobe Commerce Storefront! We're here to give you the most information and pleasure for the least effort and time. We'll start each topic with big-picture overviews to get you grounded and end with hands-on learning to make your storefront journey as fun and instructive as possible. Let's get started.
...
Our WKND demo site was built from the same boilerplate you will set up to develop your own storefront.

<Embed src="https://main--xsc-wknd-commerce--hlxsites.hlx.live/" height="520" />

## Video 🎬

TODO: Watch this video to see the steps to create and configure your Commerce storefront.
...
Explore the Commerce Playground to see the Commerce storefront in action. TODO: Add link to Commerce Playground.
