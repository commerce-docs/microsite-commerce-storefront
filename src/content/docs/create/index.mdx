...
1. Return to the Sidekick Configurator by selecting your browser's Back button. You should now see a message stating "Your Sidekick is not configured for this project yet" and an **Add project** button.
...
1. Navigate to https://pagespeed.web.dev/ and enter your `.live` storefront URL.
1. Click the **Analyze** button to run the audit.
1. You should see lighthouse scores at or very near 100 across the web vitals measured. 🚀
