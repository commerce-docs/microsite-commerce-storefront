...
Welcome! If you have 20 minutes, we can give you the foundation to make your storefront one of the fastest on the web. This tutorial will guide you through all the steps to build a new Edge Delivery Services + Commerce storefront from repo to render.
...
Here are the broader steps for creating your starter storefront:
...
The star of this **20-minute storefront** is our Commerce boilerplate template. It provides a starter storefront that is pre-configured with our Commerce components and services and pre-connected to our Commerce boilerplate backend. Start your timers. Let's go!
...
<Tabs>
  ...
  <TabItem label="SharePoint">
    ...
    <Callouts>
      1. Go to the <a href="https://adobe.sharepoint.com/:f:/r/sites/HelixProjects/Shared%20Documents/sites/starter-content-commerce" target="_blank">starter-content-commerce</a> folder.
      1. Select all its content, then select the **Copy to** button.
