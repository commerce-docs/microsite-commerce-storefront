...
1. Navigate to [aem-boilerplate-commerce](https://github.com/hlxsites/aem-boilerplate-commerce) and select the **Use this template** button > **Create a new repository** option.
...
1. Choose your GitHub organization (or owner), add a name and description, and set the repo as Public or Private (we recommend public).

   <Diagram caption="New repository form.">
     ![New repository form.](@images/create/new-repo-form.webp)
   </Diagram>

1. Select the **Create repository** button and watch GitHub create your new storefront repo.

   <Diagram caption="New storefront repository.">
     ![New storefront repository.](@images/create/create-repo.webp)
   </Diagram>
