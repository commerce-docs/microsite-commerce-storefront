...
1. Navigate to [aem-boilerplate-commerce](https://github.com/hlxsites/aem-boilerplate-commerce) and select **Use this template**, then **Create a new repository**.
...
1. (_Optional_) Write a brief **Description**. You can always add it later.
...
This app redeploys your storefront site whenever you push or merge changes to the `main` branch of your repo. Adding the app provides the Edge Delivery infrastructure (Helix Admin) with access to your repo so that it can coordinate code changes with content changes from Google Drive or SharePoint. Let's add the app.

<Diagram caption="Add AEM Code Sync to your repository.">
  ![Add AEM Code Sync to your repository.](@images/create/code-sync-app-steps.webp)
</Diagram>
...
1. Select **Save** to complete the app installation.
1. You should see a success screen if the installation completed without errors. Close the page and proceed to the next task.
...
<Tabs>
  <TabItem label="Google Drive">
    ...
    <Callouts>
      ...
      1. Select the icon and verify that `helix@adobe.com` is listed as an editor. Proceed to the next task.
  ...
  <TabItem label="SharePoint">
    ...
    1. **Send** the invitation to give Edge Delivery Services (Helix Admin) read/write access to your folder. Proceed to the next task.
...
By sharing read/write access to `helix@adobe.com`, you are enabling Edge Delivery (Helix Admin) to provide all the features of document-based authoring, such as editing, previewing, and publishing from Google Drive or SharePoint. Our next task is to add boilerplate sample content to this folder.
...
<Tabs>
  <TabItem label="Google Drive">
    ...
    1. Unzip the file and drag the contents into your folder. This will convert the Word and Excel files to Google Docs and Sheets. Proceed to the next task.
    </Callouts>
  ...
  <TabItem label="SharePoint">
    ...
    <Callouts>
      ...
      1. You should see all the ✳︎new sample content you copied. Proceed to the next task.
    </Callouts>
...
You can now preview, edit, and publish content directly from your Google Drive or SharePoint folder. Proceed to the next task.
