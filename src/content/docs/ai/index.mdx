...
* **An AI editor or coding agent that supports tool servers and agent skills** — See [Supported agents](/ai/boilerplate-skills/#supported-agents) and [Drop-in helper prerequisites](/ai/dropins-helper/#prerequisites) for supported tools.
...
2. **Add the drop-in helper.** Add the server to your editor's tool server configuration. For the configuration snippet for your editor, see [Drop-in helper installation](/ai/dropins-helper/#installation), then return here to continue installing the remaining integrations.
