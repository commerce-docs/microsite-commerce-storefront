...
Four of these skills—**researcher**, **drop-in developer**, **project manager**, and **tester**—verify slots, events, API functions, and configuration against local TypeScript definitions in your project's source code rather than published documentation. For details about the underlying APIs, see the [Blocks reference](/blocks/) and [Drop-in components](/dropins/all/introduction/).
