...
> Use the planning workflow to add a button to the product pages that allows the user to share the product quickly on social media platforms like Facebook and Twitter. The button should be displayed below the title section on the product detail page.
