...
<Aside type="note" title="Related: AI agent skills">
If you installed the <Link href="/ai/ai-agent-skills/" text="AEM Boilerplate Commerce skill set" />, its researcher skill already searches Commerce documentation for drop-in questions. Add this MCP server when you need those answers checked against your project's actual source code, not only published docs.
</Aside>
