...
{/* <Diagram caption="How the Base design tokens are built-in to drop-ins.">
  ![Diagram for how to brand drop-ins](./tokensbuiltin.svg)
</Diagram> */}
...
<CodeImport code={base} title="Base design tokens" frame="none" />
