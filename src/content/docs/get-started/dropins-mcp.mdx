...
- An AI editor that supports MCP servers: <Link href="https://cursor.sh" text="Cursor" />, <Link href="https://code.visualstudio.com" text="VS Code" /> with <Link href="https://github.com/features/copilot" text="GitHub Copilot" />, or <Link href="https://claude.ai/download" text="Claude Desktop" />
