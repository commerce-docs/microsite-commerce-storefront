...
2. **Add the server to your editor configuration.** Choose your editor below and paste the snippet into the correct config file. The editor spawns the MCP process automatically no separate server to keep running.
...
3. **Restart your editor.** The Dropins MCP appears in the tool list with 20 tools available.

4. **Verify the connection.** Ask your AI assistant:
