...
1. The merchant creates a document in DA.live, Google Docs, or SharePoint. A table in the document defines a block on the page — for example, a "Commerce Cart" table becomes the cart block.
...
[Blocks and the repository](/get-started/architecture/blocks-and-repo/) compares content and Commerce blocks and points at the repo folders that wire them to drop-ins.
