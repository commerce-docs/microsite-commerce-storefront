...
| <Term>Storefront Compatibility package</Term> | Required on Commerce PaaS (manual install on your Commerce instance). Managed automatically on Adobe Commerce as a Cloud Service and Adobe Commerce Optimizer. | [Overview](/setup/configuration/storefront-compatibility/) |
