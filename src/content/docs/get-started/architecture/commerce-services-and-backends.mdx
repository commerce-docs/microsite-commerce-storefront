...
All three backend options—Commerce on Cloud or on-premises, Adobe Commerce as a Cloud Service, and Adobe Commerce Optimizer—connect to these services. To compare them, see [Backend options](/get-started/backends/).
