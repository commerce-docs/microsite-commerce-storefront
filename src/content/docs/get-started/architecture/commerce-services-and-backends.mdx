...
| <Term>Storefront Compatibility package</Term> | Required on Commerce PaaS (manual install on your Commerce instance). Managed automatically on Adobe Commerce as a Cloud Service and Adobe Commerce Optimizer. | [Install page](/setup/configuration/storefront-compatibility/install/) |
