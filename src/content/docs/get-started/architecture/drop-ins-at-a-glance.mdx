...
The [Drop-ins introduction](/dropins/all/introduction/) lists B2C and shared packages. If you build B2B experiences, you will use extra packages and pages under [Drop-ins B2B](/dropins-b2b/) (company, quotes, purchase orders, requisition lists, and related topics).
