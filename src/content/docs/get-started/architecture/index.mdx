...
|---|---|---|
| Document | Where merchants create and edit pages | Google Docs, SharePoint, DA.live, or <Link href="/merchants/universal-editor/" text="Universal Editor" /> (a visual editor for rendered pages) |
