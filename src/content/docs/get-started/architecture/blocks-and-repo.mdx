...
Customize and connect: [Blocks reference](/boilerplate/blocks-reference/), [Storefront configuration](/setup/configuration/commerce-configuration/).

## What's next

[Blocks reference](/boilerplate/blocks-reference/) is the technical reference for every Commerce block in the boilerplate, organized by functionality and integration pattern.
