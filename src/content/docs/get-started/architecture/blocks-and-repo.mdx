...
Authoring references: <Link href={"https://docs.da.live/"} text={"Document Authoring documentation"} />, [Document Authoring](/merchants/quick-start/document-authoring/) and [Universal Editor](/merchants/quick-start/universal-editor/) Quick Starts, <Link href="https://www.aem.live/docs/authoring-guide" text="authoring guide" />, <Link href="https://www.aem.live/docs/" text="AEM documentation" />. For packages and shared vocabulary, see [Drop-ins at a glance](/get-started/architecture/drop-ins-at-a-glance/) and [Boilerplate getting started](/boilerplate/getting-started/).
