...
The [Storefront Compatibility package](https://experienceleague.adobe.com/developer/commerce/storefront/get-started/launch-checklist/storefront-compatibility/) extends the GraphQL schema provided with Adobe Commerce. It provides several new mutations and adds missing fields that are needed to fully implement your dropins.
