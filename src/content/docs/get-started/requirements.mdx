...
The [Storefront Compatibility package](storefront-compatibility/) extends the GraphQL schema provided with Adobe Commerce. It provides several new mutations and adds missing fields that are needed to fully implement your dropins.
