...
You will get the most from this topic after you have a local or preview storefront (see [Create a storefront](/get-started/create-storefront/)) so file paths and load order map to a project you can open on disk.
