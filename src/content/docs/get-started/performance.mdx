...
If your storefront feels slow or your mobile scores look low, tune `consented.js`, CSS load order, and `head.html` to match the <Term>Edge Delivery Services</Term> eager, lazy, and delayed loading pattern.
...
Don't load the scripts, fragments, and styles for UI that shoppers may never need.
