...
When you already have the project from [Create a storefront](/get-started/create-storefront/), leave the repo open so the filenames below match what you see in your editor.

The Commerce boilerplate uses the same <Term>Edge Delivery Services</Term> pattern as other Edge storefronts: eager, lazy, and delayed loading, fonts, and LCP (Largest Contentful Paint, how fast the main content shows). The headings below name the files.
