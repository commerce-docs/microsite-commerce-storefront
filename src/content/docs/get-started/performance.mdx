...
Treat any UI that stays hidden until the shopper interacts with it as lazy: load its scripts, fragments, and styles only on the interaction that reveals it, such as a click or tap, not before.
