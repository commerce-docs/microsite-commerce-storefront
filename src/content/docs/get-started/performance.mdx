...
3. After you change loading behavior, run [Lighthouse audits](/get-started/run-lighthouse/) and review [Performance and monitoring](/setup/launch/#performance-and-monitoring) on the launch checklist.
</Steps>
