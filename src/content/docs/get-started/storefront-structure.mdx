...
Full-featured shopping components that turn websites into storefronts. [Drop-in components](/discovery/architecture/#drop-ins-and-widgets) are not primitive components, like Carousels and Galleries. They provide the entire storefront shopping experience for a website using pages and other commerce features.
