...
Full-featured shopping components that turn websites into storefronts. [Drop-in components](/storefront-setup/discovery/architecture/#drop-in-components-and-widgets) are not primitive components, like Carousels and Galleries. They provide the entire storefront shopping experience for a website using pages and other commerce features.

### Commerce blocks

The integration of Commerce drop-in components into the Edge Delivery Services architecture of JavaScript blocks and document-based authoring. [Commerce blocks](/storefront-setup/discovery/architecture/#commerce-blocks) are the components that provide the content and layout for commerce pages in the storefront.
...
<OptionsTable
  ...
  options={[
    ...
    [
      ...
      {
        text: 'scripts/__dropins__/storefront-auth/containers/CustomerInformation.js',
