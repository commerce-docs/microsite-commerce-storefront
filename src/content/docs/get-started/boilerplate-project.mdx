...
- blocks/ _-- Content and Commerce blocks_
  ...
  - product-list-page-custom/ _-- Commerce block_
    - product-list-page-custom.css _-- CSS classes_
    - product-list-page-custom.js _-- JavaScript decorator_
...
Run your storefront locally using the `npm start` command and use the table below to see how each **boilerplate page** has a corresponding **Commerce block**, which wraps the **drop-in** component that provides the block with its features and functions.
...
The first column links to the Commerce block code in the boilerplate repository. The second column links to the drop-in component code that powers the block.

<OptionsTable
  compact
  options={[
    ['From the Commerce block →', 'to the drop-in component that powers it'],
    [
      {
      ...
      {
        text: 'scripts/widgets/SearchAsYouType.js',
        link: 'https://github.com/hlxsites/aem-boilerplate-commerce/blob/main/scripts/widgets/SearchAsYouType.js',
      },
    ],
    [
      {
        text: 'blocks/commerce-search-order',
        link: 'https://github.com/hlxsites/aem-boilerplate-commerce/tree/main/blocks/commerce-search-order',
      },
      {
        text: 'scripts/__dropins__/storefront-order/containers/OrderSearch.js',
        link: 'https://github.com/hlxsites/aem-boilerplate-commerce/tree/main/scripts/__dropins__/storefront-order/containers',
      },
    ],
    [
      {
      ...
      },
      {
        ...
        link: 'https://github.com/hlxsites/aem-boilerplate-commerce/blob/main/scripts/widgets/search.js',
      },
    ],
    [
      {
      ...
      },
      {
        ...
        link: 'https://github.com/hlxsites/aem-boilerplate-commerce/tree/main/scripts/__dropins__/storefront-pdp/containers',
      },
    ],
    [
      {
      ...
      },
      {
        ...
        link: 'https://github.com/hlxsites/aem-boilerplate-commerce/tree/main/scripts/__dropins__/storefront-cart/containers',
      },
    ],
    [
      {
      ...
      {
        text: 'scripts/__dropins__/storefront-checkout/containers/Checkout.js',
        link: 'https://github.com/hlxsites/aem-boilerplate-commerce/tree/main/scripts/__dropins__/storefront-checkout/containers',
      },
    ],
    [
      {
      ...
      {
        text: 'scripts/__dropins__/storefront-auth/containers/SignIn.js',
        link: 'https://github.com/hlxsites/aem-boilerplate-commerce/blob/main/scripts/__dropins__/storefront-auth/containers/SignIn.js',
      },
    ],
    [
      {
        text: 'blocks/commerce-customer-information',
        link: 'https://github.com/hlxsites/aem-boilerplate-commerce/tree/main/blocks/commerce-customer-information',
      },
      {
        text: 'scripts/__dropins__/storefront-account/containers/CustomerInformation.js',
        link: 'https://github.com/hlxsites/aem-boilerplate-commerce/tree/main/scripts/__dropins__/storefront-account/containers/CustomerInformation.js',
      },
    ],
    [
      {
        text: 'blocks/commerce-wishlist',
        link: 'https://github.com/hlxsites/aem-boilerplate-commerce/tree/main/blocks/commerce-wishlist',
      },
      {
        text: 'scripts/__dropins__/storefront-wishlist/containers/Wishlist.js',
        link: 'https://github.com/hlxsites/aem-boilerplate-commerce/tree/main/scripts/__dropins__/storefront-wishlist/containers',
      },
    ],
    [
      {
        text: 'blocks/product-recommendations',
        link: 'https://github.com/hlxsites/aem-boilerplate-commerce/tree/main/blocks/product-recommendations',
      },
      {
        text: 'scripts/__dropins__/storefront-recommendations/containers/ProductList.js',
        link: 'https://github.com/hlxsites/aem-boilerplate-commerce/tree/main/scripts/__dropins__/storefront-recommendations/containers',
      },
    ],
    [
      {
        text: 'blocks/targeted-block',
        link: 'https://github.com/hlxsites/aem-boilerplate-commerce/tree/main/blocks/targeted-block',
      },
      {
        text: 'scripts/__dropins__/storefront-personalization/containers/TargetedBlock.js',
        link: 'https://github.com/hlxsites/aem-boilerplate-commerce/tree/main/scripts/__dropins__/storefront-personalization/containers',
      },
    ],
  ]}
/>
