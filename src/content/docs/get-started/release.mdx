...
Slots are defined in the drop-in SDK and are used by the drop-in components to render content in the storefront application. The following table lists the default properties and individual drop-in slots that are available to all drop-in components:
