...
| File | Purpose |
|------|---------|
| <Link href="https://experienceleague.adobe.com/developer/commerce/storefront/llms.txt" text="llms.txt" /> | Index file: overview and links to all documentation sets (full, abridged, and topic bundles under `_llms-txt`). |
| <Link href="https://experienceleague.adobe.com/developer/commerce/storefront/llms-full.txt" text="llms-full.txt" /> | Complete documentation in one file. |
| <Link href="https://experienceleague.adobe.com/developer/commerce/storefront/llms-small.txt" text="llms-small.txt" /> | Abridged bundle (same content as the full export except the long-form release changelog page). |
| `_llms-txt/*.txt` | Smaller topical exports (for example, <Link href="https://experienceleague.adobe.com/developer/commerce/storefront/_llms-txt/dropins-reference.txt" text="drop-ins reference" />, <Link href="https://experienceleague.adobe.com/developer/commerce/storefront/_llms-txt/tutorials-reference.txt" text="tutorials" />, <Link href="https://experienceleague.adobe.com/developer/commerce/storefront/_llms-txt/blocks-reference.txt" text="blocks" />). All bundle URLs are listed from <Link href="https://experienceleague.adobe.com/developer/commerce/storefront/llms.txt" text="llms.txt" />. |
