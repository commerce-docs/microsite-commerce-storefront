...
:::note[Adobe Commerce as a Cloud Service and Adobe Commerce Optimizer]
Before you link the repo to Commerce data, confirm that [storefront services](/get-started/architecture/#storefront-services) have received synchronized catalog data from Adobe Commerce. See [Data export validation](/setup/discovery/data-export-validation/).
:::
