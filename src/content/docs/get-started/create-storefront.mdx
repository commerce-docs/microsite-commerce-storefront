...
The tutorial helps you quickly create a new Edge Delivery Services storefront using the <Term>boilerplate template</Term> in the <Link href="https://github.com/hlxsites/aem-boilerplate-commerce" text="Commerce boilerplate template" /> repository. The boilerplate provides a starter storefront that uses a pre-configured Adobe Commerce environment.
...
<Callouts>
1. Open the <Term>Site Creator</Term> app at <Link href="https://da.live/app/adobe-commerce/storefront-tools/tools/site-creator/site-creator" text="Site Creator app" /> in DA, and select **Use existing repository**.
1. Copy the GitHub owner and site values to the input fields and click **Create site**.
1. Follow the prompts, and by the end the content will have been copied to your <Term>content folder</Term>.
