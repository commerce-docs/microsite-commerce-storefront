...
Confirm your backend's prerequisites before continuing (see the [Get started](/get-started/) section for setup guidance). Unless a step says otherwise, it applies to all backend types; only **Link Repo to Data** is backend-specific.
