...
You can return later for optional steps such as <Term>Sidekick</Term>, <Term>Experience Workspace</Term>, or the Universal Editor.
...
1. (Optional) Experience Workspace or Universal Editor — Edit content in context on the rendered page.
...
### (Optional) Use Experience Workspace or Universal Editor for content editing

Use one of these paths when authors need in-context editing beyond what Site Creator sets up by default. Adobe recommends [Experience Workspace](/merchants/quick-start/experience-workspace/) for new Document Authoring projects; see [Using the Universal Editor](/merchants/quick-start/universal-editor/) instead for AEM Sites Authoring projects.
</Task>
