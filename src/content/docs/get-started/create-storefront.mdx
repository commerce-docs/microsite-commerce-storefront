...
<Callouts>
1. Open the Site Creator app at <Link href="https://da.live/app/adobe-commerce/storefront-tools/tools/site-creator/site-creator" text="Site Creator app" /> in DA, and select **Use existing repository**.
