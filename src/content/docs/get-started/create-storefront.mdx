...
1. **Add Content** to the Document Author environment hosted at `https://da.live/` using the <Link href="https://da.live/app/adobe-commerce/storefront-tools/tools/site-creator/site-creator" text="Adobe Commerce Site Creator app" /> in DA to create a new storefront based on the Commerce boilerplate.
...
<Aside type="tip" title="Adobe Commerce as a Cloud Service / Adobe Commerce Optimizer">
Adobe Commerce as a Cloud Service and Adobe Commerce Optimizer customers use the same Site Creator and DA.live content workflow as PaaS. The difference is in your backend configuration (`config.json`), which you already set up in the previous step. Your demo content will connect to your managed environment automatically.
</Aside>
