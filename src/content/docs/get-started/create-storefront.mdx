...
1. (Optional) Experience Workspace — Edit content in context on the rendered page.
...
### (Optional) Use Experience Workspace for content editing

Use this path when authors need in-context editing beyond what Site Creator sets up by default. See [Using Experience Workspace](/merchants/quick-start/experience-workspace/) for setup.
</Task>
