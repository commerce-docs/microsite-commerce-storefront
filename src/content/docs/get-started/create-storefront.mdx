...
For `npm install`, `npm start`, and local preview, use [Running locally](/boilerplate/#running-locally). If accounts and tools are not ready, read [Before you start](/get-started/before-you-start/) first.
