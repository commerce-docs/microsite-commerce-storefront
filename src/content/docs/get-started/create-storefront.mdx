...
description: Create a GitHub repository from the Commerce boilerplate, connect Code Sync and your Commerce backend, add Document Authoring content, and clone the repository. The Boilerplate getting started guide shows how to run the project on your computer and preview it in a browser.
sidebar:
  order: 1
time: '20 minutes'
---
...
To install dependencies, run a local preview, and open the storefront in your browser, follow [Boilerplate getting started](/boilerplate/getting-started/). It covers `npm install` and `npm start` in one place. If you have not gathered accounts and tools yet, read the [Before you start](/get-started/before-you-start/) topic in this collection first.
...
The following diagram shows the steps you will take to create and configure your starter storefront:
...
<Callouts>
1. Open the <Link href="https://da.live/app/adobe-commerce/storefront-tools/tools/site-creator/site-creator" text="Site Creator app" /> in DA.live, and select **Use existing repository**.
...
<Aside type="tip" title="What you have now">
  You have a Commerce storefront project on GitHub, starter content in Document Authoring, and a local clone of the repository. Next, use [Boilerplate getting started](/boilerplate/getting-started/) to run and explore the code, then customize the boilerplate and drop-in components to match your project. The What's next list below points to the same place.
</Aside>
