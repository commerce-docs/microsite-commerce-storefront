...
description: Learn how to create an Adobe Commerce storefront from the boilerplate: GitHub, Code Sync, Commerce config, DA.live content, local clone, and go-live pointers.
sidebar:
  order: 1
---
