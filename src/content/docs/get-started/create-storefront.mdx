...
description: Step-by-step guide to creating an Edge Delivery Services storefront with Commerce drop-in components for a standard B2C catalog and checkout.
time: ~20 minutes
---
...
This tutorial walks you through creating a new Edge Delivery Services storefront step by step. Each section starts with an overview and key vocabulary, then guides you through the details.
