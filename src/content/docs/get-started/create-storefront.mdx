...
ACCS and ACO customers use the same Site Creator and DA.live content workflow as PaaS. The difference is in your storefront configuration (`config.json`), which you already set up in the previous step. Your demo content will connect to your managed environment automatically.
</Aside>
