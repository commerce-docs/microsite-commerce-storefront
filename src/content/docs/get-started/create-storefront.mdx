...
Storefront supports three distinct customer scenarios. Each has different prerequisites and setup steps. Follow only the guidance for your backend. See the [Get started](/get-started/) overview for backend types and prerequisites.
...
- **Commerce PaaS**: Complete the PaaS prerequisites (Storefront Compatibility package, Data Connection service, Services Connector, Catalog Service, Live Search, Product Recommendations) before starting. Setup requires manual installation—see the [Get started](/get-started/) overview.
- **Adobe Commerce as a Cloud Service**: No additional prerequisites. All backend requirements and services are automatically managed by Adobe—see the [Get started](/get-started/) overview.
- **Adobe Commerce Optimizer**: No additional prerequisites. All backend requirements and services are automatically managed—see the [Get started](/get-started/) overview.
</Aside>
