...
Site Creator also wires up [Quick Edit and Experience Workspace](/merchants/quick-start/document-authoring/#quick-edit-and-experience-workspace) for new sites, so authors can open the storefront's live or preview page directly and edit text and images in place, without switching to the document view. It also enables the Experience Workspace for more robust authoring when on da.live. No extra setup is required.
