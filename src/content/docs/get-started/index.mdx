...
<Tabs>
  ...
  <TabItem label="SharePoint">
    ...
    <Aside type="note" title="Site templates don't matter">
      During the process of creating your storefront folder on SharePoint, you might be directed to set up a SharePoint Site, depending on your account type. If so, we don't use SharePoint Sites in Edge Delivery storefronts, so in step 3 below, you can select any template you want. It won't affect your storefront.
    </Aside>
