...
To link your storefront repo to your commerce backend, you can duplicate the [demo-config.json](https://github.com/hlxsites/aem-boilerplate-commerce/blob/main/demo-config.json) from your storefront repo and rename it to `config.json`.  The configuration settings in this file depend on which Commerce backend you are using: Adobe Commerce, Adobe Commerce as a Cloud Service, or Adobe Commerce Optimizer.

Update the storefront configuration for your project:

1. Get information about the values required for your project from the [Storefront configuration reference](../../setup/configuration/commerce-configuration.mdx) to get information about the values required for your project.
