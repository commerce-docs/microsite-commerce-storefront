...
<Aside type="tip" title="Congrats!">
  ...
  how to customize drop-ins to develop the boilerplate into a production storefront.
</Aside>

<Task>

### Access in-development drop-ins

If you want to test drop-ins that are still in development, you can access the `develop` branch of the boilerplate repo.
