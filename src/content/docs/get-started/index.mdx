...
1. **Link Repo to Content** using the `mountpoint` URL in the **`fstab.yaml`** in your GitHub repo or onboarding to [AEM's Config Service](https://www.aem.live/docs/config-service-setup) and modifying your `folders` and `content` pointers. You can use [default-fstab.yaml](https://github.com/hlxsites/aem-boilerplate-commerce/blob/main/default-fstab.yaml) or [default-site.json](https://github.com/hlxsites/aem-boilerplate-commerce/blob/main/default-site.json) as a reference.
...
1. **Add Content** in https://da.live/ using the [import tool](https://da.live/app/hlxsites/aem-boilerplate-commerce/tools/site-creator/site-creator) or the [site importer](https://da.live/apps/import), if you already have a site in SharePoint or Google Drive.
1. **Link Repo to Data** using the values in the **`config.json`** in your GitHub repo or onboarding to [AEM's Config Service](https://www.aem.live/docs/config-service-setup) and modifying your "public config." You can use [demo-config.json](https://github.com/hlxsites/aem-boilerplate-commerce/blob/main/demo-config.json) as a reference.
...
Linking your storefront repo to your commerce data can be done in two ways:

1. Use [AEM's Configuration Service](https://www.aem.live/docs/config-service-setup) and the `PublicConfig` schema from the Site Config API docs [https://www.aem.live/docs/admin.html#tag/siteConfig] (https://www.aem.live/docs/admin.html#tag/siteConfig).

1. Use the `config.json` in your storefront repo (templated from the boilerplate). This JSON object overrides the key-values found in the `PublicConfig` schema. You can use [demo-config.json](https://github.com/hlxsites/aem-boilerplate-commerce/blob/main/demo-config.json) as a reference: [https://github.com/hlxsites/aem-boilerplate-commerce/blob/main/demo-config.json](https://github.com/hlxsites/aem-boilerplate-commerce/blob/main/demo-config.json).
