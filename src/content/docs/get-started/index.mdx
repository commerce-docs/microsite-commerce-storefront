...
1. **Start Building** by setting up your local development environment, installing the dependencies, and starting the development server to explore your new storefront.
...
Use the values in the **`config.json`** in your GitHub repo or use [AEM's Config Service](https://www.aem.live/docs/config-service-setup) and modify your "public config." You can use [demo-config.json](https://github.com/hlxsites/aem-boilerplate-commerce/blob/main/demo-config.json) as a reference.

TODO: Expand this section to include more details about the config service and how to set it up.
