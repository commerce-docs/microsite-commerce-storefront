...
If you have an existing Edge Delivery Service site, you can import both the code and the content into the Document Author environment using the [Site importer tool](https://da.live/docs/operations/import).
:::
