...
If you have an existing Edge Delivery Service site for your Commerce project, you can skip steps 1 through 5. Create your site by importing both the code and the content into the Document Author environment using the [Site importer tool](https://da.live/docs/operations/import).
:::
