...
You will get the most from this topic after you have a running storefront (for example, after [Create a storefront](/get-started/create-storefront/)) so you can match the boilerplate suite in your `package.json` to the tables below.
