...
The table below maps the key files and folders in the [boilerplate `scripts/` folder](https://github.com/hlxsites/aem-boilerplate-commerce/tree/main/scripts) and `blocks/`.
...
To see how blocks connect to drop-ins, browse the [Commerce boilerplate repository](https://github.com/hlxsites/aem-boilerplate-commerce). To customize drop-in behavior beyond what configuration allows, use the [documented extension patterns](/dropins/all/extending/).
