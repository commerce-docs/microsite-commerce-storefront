...
The table below maps the key files and folders in the <Link href={"https://github.com/hlxsites/aem-boilerplate-commerce/tree/main/scripts"} text={"boilerplate `scripts/` folder"} /> and `blocks/`.
