...
Drop-in components are domain-driven Commerce UI packages (for example, `npm install @dropins/storefront-cart`). See the [Drop-ins introduction](/dropins/all/introduction/) for the full set. Commerce blocks and initializers mount them and call Commerce APIs. Customize them using the [documented extension patterns](/dropins/all/extending/).
...
You can add drop-in components to your project as npm packages:
