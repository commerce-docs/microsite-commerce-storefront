...
Edge Delivery Services hosts your site. **Commerce blocks** use the boilerplate and **drop-in components** to reach your Commerce backend and services. This topic shows the overall architecture, then explains how each part fits together.
...
- **View the diagrams** ([How the storefront parts fit together](#how-the-storefront-parts-fit-together), [How the pieces connect](#how-the-pieces-connect)) for context.
- **Follow [How a page loads](#how-a-page-loads)** to trace the path from a document table to a Commerce API call.
- **Open [Boilerplate and blocks](#boilerplate-and-blocks) onward** when you map concepts to repo folders (`scripts/`, `blocks/`, storefront configuration).
