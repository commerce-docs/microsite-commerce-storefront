...
Within this storefront guide, the [Storefront developer guide](/get-started/) is a quick entry point with links to onboarding tasks. It does not spell out how blocks, drop-ins, boilerplate, and Commerce APIs fit together. For that storefront model, use this Architecture topic together with [Drop-ins introduction](/dropins/all/introduction/) and [Boilerplate getting started](/boilerplate/getting-started/).
</Aside>
