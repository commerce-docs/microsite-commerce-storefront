...
1. You installed the <Term>Storefront Compatibility package</Term> ([Install page](/setup/configuration/storefront-compatibility/install/)), which fills gaps in the core Commerce GraphQL schema that drop-ins require.
