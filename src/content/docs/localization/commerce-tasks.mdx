...
description: Verify multistore configuration, translate drop-in placeholder files, and test Commerce functionality after a content author translates page content.
slug: dropins/all/commerce-tasks
---
...
After translating your storefront content using [Document Authoring](/merchants/quick-start/content-localization/), complete these Commerce-specific tasks.
...
<Aside type="note" title="Placeholder file format">

Placeholder files contain key-value pairs where the keys must remain in English (used by the code), but you should translate the values. For example: `"addToCart": "Ajouter au panier"` (French) instead of `"addToCart": "Add to Cart"`.

</Aside>

See [Labeling and Localization](/dropins/all/labeling/) for how these placeholder files work with drop-in dictionaries.
...
<Aside type="caution" title="Store view headers">
...
For links that always point to a specific locale (like store switcher links), add `#nolocal` to the URL:
...
**See also:** [Localizing links](/dropins/all/linking/) for implementation details.
...
- <Link href="https://experienceleague.adobe.com/en/docs/commerce-admin/start/setup/websites-stores-views" text="Websites, Stores, and Views" /> - Adobe Experience League

### Edge Delivery Services

- <Link href="https://www.aem.live/docs/" text="Edge Delivery Services Documentation" /> - aem.live
