...
After a content author translates page content using the [Universal Editor](/merchants/quick-start/content-localization-universal-editor/) or [Document Authoring](/merchants/quick-start/content-localization/) workflow, complete these Commerce-specific tasks so drop-in components, store views, and pricing work correctly in each locale.
