...
For a summary of link localization and using `#nolocal` in store switchers, see [Commerce localization tasks - Link localization](/dropins/all/commerce-tasks/#link-localization).
...
The Commerce Boilerplate enables this function by default via `scripts/script.js`.
