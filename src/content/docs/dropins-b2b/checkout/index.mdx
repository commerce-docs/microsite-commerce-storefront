...
The topics in this section focus on the B2B-specific payment method containers that extend the Checkout drop-in for enterprise purchasing scenarios.

### Containers

Describes the B2B payment method containers, including configuration options and customization capabilities for Payment on Account and Purchase Order payment methods.
