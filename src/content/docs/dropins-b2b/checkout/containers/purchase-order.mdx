...
| `onReferenceNumberChange` | `function` | No | Callback function to handle reference number changes when the input field value updates. |
| `onReferenceNumberBlur` | `function` | No | Callback function to handle reference number blur events when the input field loses focus. |
