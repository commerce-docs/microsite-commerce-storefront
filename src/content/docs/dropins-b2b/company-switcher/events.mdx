...
<strong>Version: 1.0.6-beta5</strong>
</div>
...
| [company/updated](#companyupdated) | Listens | Fired by Company (`company`) when the component state is updated. |
| [companyContext/changed](#companycontextchanged) | Emits and listens | Triggered when a change occurs. |
