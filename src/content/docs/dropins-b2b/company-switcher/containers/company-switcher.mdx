...
Dropdown picker for switching between companies. Automatically hides when user has access to only one company.
...
|---|---|---|---|
| `ariaLabel` | `string` | No | Accessibility label for the company picker dropdown. |
