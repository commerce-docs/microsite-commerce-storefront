...
|---|---|---|---|
| `ariaLabel` | `string` | No | Sets a custom aria-label for the company picker dropdown. Use this to improve accessibility by providing descriptive text for screen readers, especially when the picker is embedded in contexts where the default label may not be clear. |
