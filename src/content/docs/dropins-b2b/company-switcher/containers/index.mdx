...
| --------- | ----------- |
| [CompanySwitcher](/dropins-b2b/company-switcher/containers/company-switcher/) | Dropdown picker component that allows users to switch between companies they have access to. |
