...
| --------- | ----------- |
| [CompanySwitcher](/dropins-b2b/company-switcher/containers/company-switcher/) | Provides a dropdown selector for users to switch between multiple company associations and set the active company context. |
