...
{/*
  ...
  - Placeholders: Purchase Order, Purchase Order, EVENT_NAME, and so on.
...
| [purchase-order/placed](#purchase-orderplaced-emits) | Emits | Emitted when a purchase order is placed. |
