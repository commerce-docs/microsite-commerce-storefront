...
Confirmation screen after purchase order creation showing PO number and details link.
...
|---|---|---|---|
| `purchaseOrderNumber` | `string \| number` | Yes | Purchase order number to display in confirmation. |
| `routePurchaseOrderDetails` | `function` | Yes | Function to generate URL for viewing purchase order details. |
