...
|---|---|---|---|
| `initialPageSize` | `PageSizeListProps[]` | No |  |
| `routeCreateApprovalRule` | `function` | No |  |
| `routeEditApprovalRule` | `function` | No |  |
| `routeApprovalRuleDetails` | `function` | No |  |
| `setColumns` | `function` | No |  |
| `setRowsData` | `function` | No |  |
| `className` | `string` | No | Additional CSS classes to apply to the container |
| `withHeader` | `boolean` | No |  |
| `withWrapper` | `boolean` | No |  |
| `skeletonRowCount` | `number` | No |  |
