...
|------|------|----------|-------------|
| `PurchaseOrderActions` | `SlotProps` | Yes | Custom component or render function for purchase order action buttons. Use to add organization-specific actions like custom approval workflows, external system integrations, or bulk operations. |
