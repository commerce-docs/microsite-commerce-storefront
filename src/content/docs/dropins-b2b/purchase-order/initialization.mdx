...
<Aside type="tip">
For complete dictionary customization including all available keys and multi-language support, see the [Purchase Order Dictionary](/dropins/purchase-order/dictionary/) page.
</Aside>
