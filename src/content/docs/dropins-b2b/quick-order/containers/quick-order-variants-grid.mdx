...
There are no admin panel configurations that directly affect the container. Grid Ordering is enabled via the Product Details block configuration. See the <Link href="https://github.com/hlxsites/aem-boilerplate-commerce/blob/b2b/blocks/product-details/product-details.js" text="product-details block" /> for setup.
