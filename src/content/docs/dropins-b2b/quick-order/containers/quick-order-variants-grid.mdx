...
<Diagram caption="QuickOrderVariantsGrid container on product detail page">
  ![QuickOrderVariantsGrid container showing variant grid with image, SKU, availability, price, quantity, and subtotal columns](@images/quick-order-variants-grid.png)
</Diagram>
