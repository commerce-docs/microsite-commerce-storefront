...
<Diagram caption="QuickOrderItems container with product list and search">
  ![QuickOrderItems container showing product list with quantities, search input, and Add All to Cart button](@images/quick-order-items.png)
</Diagram>
