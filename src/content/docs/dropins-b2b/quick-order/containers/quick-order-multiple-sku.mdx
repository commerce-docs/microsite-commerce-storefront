...
<Diagram caption="QuickOrderMultipleSku container with SKU text area">
  ![QuickOrderMultipleSku container showing text area for entering multiple SKUs and Add to List button](@images/quick-order-multiple-sku.png)
</Diagram>
