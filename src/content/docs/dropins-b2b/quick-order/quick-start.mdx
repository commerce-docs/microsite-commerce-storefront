...
The <Link href="https://github.com/hlxsites/aem-boilerplate-commerce" text="Commerce boilerplate" /> uses this pattern for the Quick Order page with all three containers:
...
**Example containers:** `QuickOrderItems`, `QuickOrderMultipleSku`, `QuickOrderCsvUpload`
