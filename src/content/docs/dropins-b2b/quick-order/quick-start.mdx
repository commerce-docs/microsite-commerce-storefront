...
**New to drop-ins?** See [Connect a drop-in](/dropins/all/quick-start/) for step-by-step instructions.
...
- [Dictionary](/dropins-b2b/quick-order/dictionary/) — i18n keys and customization
- [Styles](/dropins-b2b/quick-order/styles/) — CSS classes and styling
