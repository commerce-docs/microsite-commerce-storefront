...
<Aside type="note">
The drop-in also emits `quick-order/add-to-cart-success` (payload: `void`) internally when add-to-cart completes. For integration, listen to `cart/product/added` from the Cart drop-in instead.
</Aside>
