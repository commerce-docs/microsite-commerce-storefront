...
|---|---|---|---|
| `isAuthenticated` | `boolean` | No | Indicates authentication status. Use this to conditionally show registration or redirect to account. |
...
| `onSuccess` | `function` | No | Callback function triggered on successful completion. Use this to implement custom success handling, navigation, or notifications. |
| `onError` | `function` | No | Callback function triggered when an error occurs. Use this to implement custom error handling, logging, or user notifications. |
