...
This event listens for changes in the company context (`companyContext`), such as switching between different companies or updating the current company's details.
