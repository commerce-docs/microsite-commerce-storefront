...
|-------|-----------|-------------|
| [company/updated](#companyupdated-emits) | Emits | Emitted when company profile or related company data changes. |
| [companyStructure/updated](#companystructureupdated-emits) | Emits | Emitted when the company organizational structure changes. |
| [companyContext/changed](#companycontextchanged-listens) | Listens | Fired by Company Context (`companyContext`) when company context changes. |
