...
|---|---|---|---|
| `hideHeading` | `boolean` | No |  |
| `hideFooter` | `boolean` | No |  |
| `routeProduct` | `function` | No |  |
| `showMaxItems` | `boolean` | No |  |
| `attributesToHide` | `SwitchableAttributes[]` | No |  |
| `accordion` | `boolean` | No |  |
| `variant` | `'primary' \| 'secondary'` | No |  |
| `showDiscount` | `boolean` | No |  |
| `showSavings` | `boolean` | No |  |
