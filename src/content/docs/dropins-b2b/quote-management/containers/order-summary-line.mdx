...
| `classSuffixes` | `Array<string>` | No | Provides an array of CSS class suffixes for styling variants. Use this to apply different visual styles to order summary line items based on their type or context. |
