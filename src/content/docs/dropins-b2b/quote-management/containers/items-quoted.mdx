...
|------|------|----------|-------------|
| `ProductListTable` | `function` | No | Custom slot for rendering product list table |
| `QuotePricesSummary` | `SlotProps` | No | Custom slot for rendering quote prices summary |
