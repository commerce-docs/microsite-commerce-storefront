...
|---|---|---|---|
| `pageSize` | `number` | No | Sets the number of items displayed per page for pagination. Controls how many quote items appear in each page view. Use this to optimize display for different screen sizes or match user preferences. |
