...
|---|---|---|---|
| `quoteData` | `NegotiableQuoteModel` | No | The negotiable quote data object containing the comments history. Required to display the conversation thread between buyer and seller throughout the negotiation process. |
