...
The **Quote Management** drop-in provides additional configuration options beyond the standard `langDefinitions`. These options customize drop-in-specific behaviors and features.
