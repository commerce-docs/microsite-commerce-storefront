...
<strong>Version: unknown (documented from main)</strong>
</div>


<Aside type="caution" title="Version Mismatch">
The boilerplate specifies version **unknown**, but this documentation was generated from **main** because the specific version tag was not found in the repository. The documented configuration may differ from the published package version.
</Aside>
