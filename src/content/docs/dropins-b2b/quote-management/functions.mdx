...
Sets the expiration date for a negotiable quote template. Buyers or sellers define when a quote template expires, after which it stops generating new quotes.
