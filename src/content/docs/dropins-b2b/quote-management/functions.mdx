...
Sets the expiration date for a negotiable quote template. The function calls the <Link href="https://developer.adobe.com/commerce/webapi/graphql/schema/b2b/negotiable-quote/mutations/set-quote-template-expiration-date/" text="setQuoteTemplateExpirationDate" /> mutation.
