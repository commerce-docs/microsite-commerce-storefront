...
{/*
  ...
  - Placeholders: Quote Management, Quote Management, EVENT_NAME, and so on.
...
| [quote-management/initialized](#quote-managementinitialized-emits) | Emits and listens | Triggered when the component completes initialization. |
| [quote-management/negotiable-quote-close-error](#quote-managementnegotiable-quote-close-error-emits) | Emits and listens | Emitted and consumed for internal and external communication. |
| [quote-management/negotiable-quote-closed](#quote-managementnegotiable-quote-closed-emits) | Emits and listens | Emitted and consumed for internal and external communication. |
| [quote-management/permissions](#quote-managementpermissions-emits) | Emits and listens | Triggered when permissions are updated. |
| [quote-management/quantities-updated](#quote-managementquantities-updated-emits) | Emits and listens | Emitted and consumed for internal and external communication. |
| [quote-management/quote-data](#quote-managementquote-data-emits) | Emits and listens | Emitted and consumed for internal and external communication. |
| [quote-management/quote-duplicated](#quote-managementquote-duplicated-emits) | Emits and listens | Emitted and consumed for internal and external communication. |
| [quote-management/quote-items-removed](#quote-managementquote-items-removed-emits) | Emits and listens | Emitted and consumed for internal and external communication. |
| [quote-management/quote-renamed](#quote-managementquote-renamed-emits) | Emits and listens | Emitted and consumed for internal and external communication. |
| [quote-management/quote-sent-for-review](#quote-managementquote-sent-for-review-emits) | Emits and listens | Emitted and consumed for internal and external communication. |
| [quote-management/quote-template-data](#quote-managementquote-template-data-emits) | Emits and listens | Emitted and consumed for internal and external communication. |
| [quote-management/shipping-address-set](#quote-managementshipping-address-set-emits) | Emits and listens | Emitted and consumed for internal and external communication. |
...
Used in: [`quote-management/line-item-note-set`](#quote-managementline-item-note-set-emits), [`quote-management/negotiable-quote-requested`](#quote-managementnegotiable-quote-requested-emits), [`quote-management/quantities-updated`](#quote-managementquantities-updated-emits), [`quote-management/quote-data`](#quote-managementquote-data-emits), [`quote-management/quote-data/initialized`](#quote-managementquote-datainitialized-emits), [`quote-management/quote-duplicated`](#quote-managementquote-duplicated-emits), [`quote-management/quote-items-removed`](#quote-managementquote-items-removed-emits), [`quote-management/quote-renamed`](#quote-managementquote-renamed-emits), [`quote-management/quote-sent-for-review`](#quote-managementquote-sent-for-review-emits), [`quote-management/shipping-address-set`](#quote-managementshipping-address-set-emits).
