...
Grid view of all requisition lists with create, rename, and delete actions.
...
|---|---|---|---|
| `routeRequisitionListDetails` | `function` | No | Function to generate URL for requisition list details. Receives list UID. |
