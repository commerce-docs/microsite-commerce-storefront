...
|---|---|---|---|
| `mode` | `RequisitionListFormMode` | Yes | The form mode determining whether to create a new requisition list or edit an existing one. Use 'create' for new lists and 'edit' when modifying existing lists. |
| `requisitionListUid` | `string` | No | The unique identifier for the requisition list being edited. Required when mode is 'edit' to load the existing list data. |
