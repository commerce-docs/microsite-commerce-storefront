...
| `beforeAddProdToReqList` | `function` | No | Callback function triggered before adding the product to a requisition list. Use to validate product configuration, check permissions, or show confirmation dialogs. |
