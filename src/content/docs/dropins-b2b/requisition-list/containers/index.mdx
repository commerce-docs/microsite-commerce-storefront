...
| [SharedRequisitionList](/dropins-b2b/requisition-list/containers/shared-requisition-list/) | Handles the recipient side of the sharing flow by loading a read-only preview from the token and letting the recipient import the list on demand. |
