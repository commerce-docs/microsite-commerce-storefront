...
The Requisition List drop-in enables management of requisition lists on Adobe Commerce storefronts. It supports multiple requisition lists per account. Company users can add products to a requisition list from product detail and product list pages.
