...
Visit the [Slots](/developer/commerce/storefront/product-details/pdp-slots/) page for slot details and usage information.
...
<OptionsTable
  ...
  options={[
    ...
    ['mobile', 'boolean', 'No', 'Whether to display the carousel on mobile devices.'],
    [
      'loopable',
      'boolean',
      'No',
