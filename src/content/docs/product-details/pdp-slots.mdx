...
The slots for Product Details are defined in the `ProductDetailsProps` interface. Their default implementations populates contain UI controls from the dropins library and HTML elements.
