...
For the author workflow (open the right sheet in Document Authoring, edit a value, and publish the sheet so the change reaches the page), see [Labels and placeholders](/merchants/quick-start/labels-and-placeholders/). The rest of this page is the developer-side reference: the default keys and values shipped in the boilerplate.
