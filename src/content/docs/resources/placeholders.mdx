...
These JSON files contain all the current placeholder keys and their corresponding values for each drop-in component. You can reference these files to see the exact structure and values used in the boilerplate.
