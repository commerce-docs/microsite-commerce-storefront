...
description: Learn how to configure, manage and display the Terms & Conditions feature during checkout process.
---
...
The Terms & Conditions feature must be enabled and configured in order to be used during a guest checkout process before placing the order. The terms and conditions configured will be displayed on the Checkout component inside the [TermsAndConditions container](/dropins/checkout/containers/terms-and-conditions/) as checkboxes within a label containing text and links directing them to the appropriate configured agreements pages.
...
Please follow the next step-by-step guide to enable and configure the Terms and Conditions:
...
1. **Using EDS**
    ...
    Please visit the [TermsAndConditions container](/dropins/checkout/containers/terms-and-conditions/) to see some examples of how these labels will be used.
</Callouts>
...
1. Click the "Add New Condition" button providing the next Terms and Conditions information:
    ...
    Please visit the [TermsAndConditions container](/dropins/checkout/containers/terms-and-conditions/) to see some examples of how they will be used.
</Steps>
