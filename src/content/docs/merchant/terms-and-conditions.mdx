...
<Aside type="tip" title="TermsAndConditions configurable on a per store-view basis">
  ...
  Visit the [Multi-store setup](/merchant/multistore/) documentation for more information on how to build blocks and configure the storefront structure based on **Edge Delivery Services (EDS)**.
</Aside>
...
1. Under **SALES**, select **Checkout**.

1. In **Checkout Options**, set **Enable Terms and Conditions** to "Yes" for the store-view desired.
...
1. Navigate to **Stores** > **SETTINGS** > **Terms and Conditions**.
