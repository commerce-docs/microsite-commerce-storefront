...
Data export synchronizes data between an Adobe Commerce instance and connected [storefront services](/discovery/architecture/#storefront-services). Storefront services are required for drop-ins to work correctly.
