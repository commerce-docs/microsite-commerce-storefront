...
:::tip
Instead of launching all features at once, start with a fresh Commerce project launch with the minimum viable feature set. Add additional features as needed.
:::
...
<Diagram caption="Iterative rollout process.">
  ![Iterative rollout process.](@images/implementation/iterative-rollout.png)
</Diagram>
