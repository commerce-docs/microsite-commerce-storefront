...
- **currentsku**: Current product SKU. Required for non-PDP pages only. On PDP pages, the boilerplate reads this automatically from the product context (Adobe Client Data Layer).
