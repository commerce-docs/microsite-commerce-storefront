...
- **PDP pages**: Set only `recId`. The boilerplate supplies the seed SKU from ACDL product context. Anchor price is included automatically when a dynamic or relative price filter operator requires it.
