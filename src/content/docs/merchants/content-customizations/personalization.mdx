...
- **<Term term="Fragment path">fragment</Term>**: Path to a separate content document. If you do not set this, place the content in the last merged full-width row in the `targeted-block` table, as described above. Optional.
