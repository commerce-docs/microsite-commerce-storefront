...
This guide will walk you through the process of localizing your Edge Delivery content blocks of your storefront.
...
The following diagram provides the basic workflow for translating the Edge Delivery content blocks of your storefront into multiple languages using the Document Authoring apps <Link href="https://da.live" text="da.live" />.
