...
This guide will walk you through the process of localizing the content of your storefront using DA.live.
...
:::note
To achieve full localization—including storefront setup (currency, translations, localized storefront links) and enabling the store switcher—developers the developers for your storefront site need to follow the steps outlined in [multistore setup](/merchants/multistore/).
:::
