...
This guide covers localization workflows for Document Authoring Tool (da.live). If you're using Universal Editor and AEM Cloud Service instead, see [Localization (Universal Editor)](/merchants/multistore/content-localization-universal-editor/) for the AEM Cloud Service translation workflow.
