...
You can also create a `config.json` file in your code repo root with the correct structure and values. See [demo-config.json](https://github.com/hlxsites/aem-boilerplate-commerce/blob/main/demo-config.json) for details.

#### Public Configuration

You must also update the `config.json` file in your project or your public config in config service to include configuration overrides for the new store view. In this file, you'll define store view-specific settings, such as service headers and analytics values. The `key` of each override object must match the root folder path of the corresponding store view. These values will be merged into the default configuration.
...
If you are using the Config Service, read the following documentation to learn how to publish your updates to the Config Service for your site.

- https://www.aem.live/docs/admin.html#schema/SiteConfig
- https://www.aem.live/docs/admin.html#tag/siteConfig/operation/updateConfigSite
