...
description: Learn about the Document Authoring tool in the Storefront Builder.
---

The Document Authoring tool is the content management system (CMS) at the heart of Storefront Builder. It is where your storefront's pages, blocks, and assets are authored, organized, and managed. 
