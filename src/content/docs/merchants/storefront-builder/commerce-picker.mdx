...
Go to the <Link href={"https://developer.adobe.com/uix/docs/extension-manager/extension-developed-by-adobe/ue-product-picker/"} text={"Universal Editor Product Picker documentation"} /> and complete the setup process.
