...
<Aside type="note">
Before the picker can browse your catalog, ask your developer to complete [Commerce Picker configuration](/setup/configuration/commerce-picker/) (a one-time `config.json` edit).
</Aside>
