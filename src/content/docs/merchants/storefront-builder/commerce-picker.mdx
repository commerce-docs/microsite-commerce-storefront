...
The Commerce Picker can be installed for both the Visual Editor and Document Authoring tool. Choose the installation method based on your authoring environment.
