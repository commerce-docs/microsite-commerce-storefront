...
Product pages are excluded by default. If your developer has configured [AEM Commerce prerender](/setup/configuration/aem-prerender/), it publishes each product page and updates the sitemap automatically. Otherwise, ask your developer to include them.
...
Large catalogs or multi-language sites can have more than one sitemap file. Ask your developer to give you the complete list of sitemap URLs, then submit each one to Google Search Console.
</Aside>
