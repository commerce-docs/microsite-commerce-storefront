...
<Aside type="tip" title="TermsAndConditions configurable on a per store-view basis">
  ...
  Visit the [Multi-store setup](/merchants/multistore/) documentation for more information on how to build blocks and configure the storefront structure based on **Edge Delivery Services (EDS)**.
</Aside>
