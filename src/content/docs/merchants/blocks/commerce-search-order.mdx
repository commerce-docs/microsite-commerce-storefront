...
Customers find orders by order number and email through this block. Place it on guest order lookup pages.

<Diagram caption="Commerce Search Order block.">
  ![Commerce Search Order block.](/images/placeholder.webp)
</Diagram>
