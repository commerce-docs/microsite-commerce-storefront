...
You may be editing one locale sheet while previewing a different locale page. Edit the sheet whose folder matches the URL you preview. If translations still look wrong after that, ask your developer to check store view and multistore configuration — see [Commerce localization tasks](/dropins/all/commerce-tasks/).
...
For the developer-side multi-locale checklist, see [Commerce localization tasks](/dropins/all/commerce-tasks/). For details on how drop-ins use placeholders, see [Labeling and localizing drop-in components](/dropins/all/labeling/).
