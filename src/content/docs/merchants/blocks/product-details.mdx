...
**defaultSku**: Specifies a default product SKU for the product details block. Use this when creating a template page that should display a specific product by default. The block loads the product matching this SKU when the page does not have a product SKU in the URL.
