...
|----------|------|---------|-------------|----------|-------------|
| `minified-view` | boolean (as string) | false | Controls whether addresses are displayed in minified or full view mode | No | Changes the visual layout and available actions |
