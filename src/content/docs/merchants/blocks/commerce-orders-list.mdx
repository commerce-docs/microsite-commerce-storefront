...
**search**: Shows the order search box in the full view of the order history page, so customers can find orders by order number, product name, or product SKU. Set to `false` to hide it. Default: `true`.
