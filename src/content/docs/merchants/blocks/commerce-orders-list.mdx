...
Copy this table into your document to configure the `commerce-orders-list` block. Modify the values in the second column to customize the block's behavior. You can remove any rows for properties you don't need to configure.
