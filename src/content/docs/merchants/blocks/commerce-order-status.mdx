...
Customers view order status and create returns through this block. Place it on order detail pages.

<Diagram caption="Commerce Order Status block.">
  ![Commerce Order Status block.](/images/placeholder.webp)
</Diagram>
