...
Customers see products included in orders through this block. Place it on order detail pages.

<Diagram caption="Commerce Order Product List block.">
  ![Commerce Order Product List block.](/images/placeholder.webp)
</Diagram>
