...
For the full list and how to author them, see the <Link href="https://www.aem.live/developer/block-collection" text="Block Collection documentation" /> and the <Link href="https://www.aem.live/docs/authoring" text="content blocks tutorial" />.
