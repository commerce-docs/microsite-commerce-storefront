...
Page metadata is a special table that controls page-level properties. Unlike [section metadata](/merchants/blocks/section-metadata/), which styles sections, page metadata affects the entire page — its SEO, caching behavior, social sharing appearance, and commerce-specific settings such as which product to display.
