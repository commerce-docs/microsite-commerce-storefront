...
Copy this table into your document to configure the `commerce-returns-list` block. Modify the values in the second column to customize the block's behavior. You can remove any rows for properties you don't need to configure.
...
|----------|---------|------|-------------|
| `minified-view` | false | No | Controls whether returns are displayed in minified or full view mode. Changes the visual layout and available actions. |
