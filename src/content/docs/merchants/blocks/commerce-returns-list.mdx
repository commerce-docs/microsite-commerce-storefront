...
Copy this table into your document to configure the `commerce-returns-list` block:
...
|----------|------|---------|-------------|----------|-------------|
| `minified-view` | boolean (as string) | false | Controls whether returns are displayed in minified or full view mode | No | Changes the visual layout and available actions |
