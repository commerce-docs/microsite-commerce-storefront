...
Customers request returns for purchased items through this block. Place it on return request pages.

<Diagram caption="Commerce Create Return block.">
  ![Commerce Create Return block.](/images/placeholder.webp)
</Diagram>
