...
1. Preview any document in your CitiSignal site (before publishing live) by selecting the Preview/Publish button (airplane icon in upper-right of screen), then selecting the **Preview** button.
