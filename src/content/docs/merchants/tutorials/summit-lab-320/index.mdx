...
1. You have the **Storefront Builder** (Code Name: Document Authoring) open in your browser.
...
1. You can preview the landing page of your CitiSignal by selecting the Preview/Publish button (airplane icon on upper-right), then selecting the **Preview** button. 
