...
<Diagram caption="Create the new folder and document">
  ![Create the new folder and document](./images/1_create-the-page.webp)
</Diagram>
...
<Diagram caption="Apply the Template">
  ![Apply the Template](./images/1_apply-the-template.webp)
</Diagram>
...
<Diagram caption="Preview the Page">
  ![Preview the Page](./images/1_preview-the-page.webp)
</Diagram>
</Task>
...
<Diagram caption="Change the product-details block">
  ![Change product-details block](./images/1_change-product-details-block.webp)
</Diagram>
...
<Diagram caption="Change the the Hero block">
  ![Change the Hero block](./images/1_change-hero-block.webp)
</Diagram>
...
<Diagram caption="Change and add teaser blocks">
  ![Change and add teaser blocks](./images/1_change-add-teaser-blocks.webp)
</Diagram>
...
<Diagram caption="Add CTA buttons">
  ![Add CTA buttons](./images/1_add-cta-buttons.webp)
</Diagram>
...
<Diagram caption="Final preview of the iPhone 13 product page">
  ![Final preview of the iPhone 13 product page](images/FinalPDP.webp)
</Diagram>
...
<Diagram caption="Update the Hero banner with in-context editing">
  ![Update the Hero banner with in-context editing](images/1_incontext-editing3.webp)
</Diagram>
</Task>
...
<Diagram caption="Update the Hero banner using GenAI">
  ![Update the Hero banner using GenAI](images/1_ai-editing.webp)
</Diagram>
</Task>
