...
<Diagram caption="Create the new folder and document">
  ![Create the new folder and document](./images/1_create-the-page.png)
</Diagram>
...
1. Apply the Edit menu → **Library** → **Templates**.
1. Select the *Single Product Detail page* template.
</Steps>

<Diagram caption="Apply the Template">
  ![Apply the Template](./images/1_apply-the-template.png)
</Diagram>
...
<Diagram caption="Preview the Page">
  ![Preview the Page](./images/1_preview-the-page.png)
</Diagram>
</Task>
...
The Single Product Detail page template comes with a `product-details` block, also known as a Product Detail Page (PDP) drop-in. Like other document blocks, the PDP drop-in is a two-column table — **property names** on the left, **property values** on the right. Make the following changes to the `product-details` block.

- `carousel-layout`: **`quad`** 
- `featured`: **`true`** 

<Diagram caption="Change the product-details block">
  ![Change product-details block](./images/1_change-product-details-block.png)
</Diagram>
...
1. Navigate the **AEM Assets library** from the folders on the left (see screenshot): A`ll Assets > summit-l320`.
...
<Diagram caption="Change the the Hero block">
  ![Change the Hero block](./images/1_change-hero-block.png)
</Diagram>
...
- **Header 3 text:** `New to CitiSignal?` 
...
{/* Page Break for PDF */}
<div style="page-break-after: always; margin-bottom: 2rem; padding-bottom: 2rem;"></div>

<Diagram caption="Change and add teaser blocks">
  ![Change and add teaser blocks](./images/1_change-add-teaser-blocks.png)
</Diagram>
...
<Diagram caption="Update the page layout"> 
  ![Update the page layout](images/1_update-page-layout.png)
</Diagram>
...
<Diagram caption="Add CTA buttons">
  ![Add CTA buttons](./images/1_add-cta-buttons.png)
</Diagram>
...
<Diagram caption="Final preview of the iPhone 13 product page">
  ![Final preview of the iPhone 13 product page](images/FinalPDP.png)
</Diagram>
...
<Diagram caption="Update the Hero banner using the Universal Editor">
  ![Update the Hero banner using the Universal Editor](images/1_incontext-editing3.png)
</Diagram>
</Task>
...
<Diagram caption="Update the Hero banner using GenAI">
  ![Update the Hero banner using GenAI](images/1_ai-editing.png)
</Diagram>
</Task>

:::tip[Well done!]
You just created a new product page and used AI to take your content to the next level!
:::
</Tasks>
