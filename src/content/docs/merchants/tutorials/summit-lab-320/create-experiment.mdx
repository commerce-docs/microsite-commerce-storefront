...
<Diagram caption="Create a Cart page challenger">
  ![Create a Cart page challenger](@images/labworkbook/3_cart-page-challenger.webp)
</Diagram>
...
<Diagram caption="Enable Estimated Delivery Date">
  ![Enable Estimated Delivery Date](@images/labworkbook/3_cart-page-edd.webp)
</Diagram>
...
<Diagram caption="Publish the challenger">
  ![Publish the challenger](@images/labworkbook/3_cart-page-experiment-entry.webp)
</Diagram>
