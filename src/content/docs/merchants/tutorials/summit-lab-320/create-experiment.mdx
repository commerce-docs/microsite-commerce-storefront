...
1. Create a new experiment with these parameters: <br/>
   ...
   **Control:** Pre-populated with the `/cart` page URL <br/>
   **variant-1 (challenger):** `https://main--seat-xx--adobe-summit-l320.aem.page/cart-copy` (replacing `xx` with your seat number) <br/>
   **Start date:** `Today` <br/>
