...
Page metadata is a special table that controls page-level properties. Unlike [section metadata](/merchants/quick-start/section-metadata/), which styles sections, page metadata affects the entire page — its SEO, caching behavior, social sharing appearance, and commerce-specific settings such as which product to display.
...
Open the document in the [Universal Editor](/merchants/quick-start/universal-editor/) or the [Document Authoring tool](/merchants/quick-start/document-authoring/).
...
At the top of your document (typically before any [commerce blocks](/merchants/blocks/)), add a new table with exactly two columns.
...
<tr>
<td style="width: 50%; padding: 0.75rem; border: 1px solid var(--sl-color-gray-5);">Title</td>
<td style="width: 50%; padding: 0.75rem; border: 1px solid var(--sl-color-gray-5);">New Arrivals</td>
</tr>
<tr>
