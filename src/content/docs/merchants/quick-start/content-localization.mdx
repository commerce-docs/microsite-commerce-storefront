...
- **AEM Sites Authoring**: Content authored in AEM as a Cloud Service, out of scope for Commerce Storefront. See [Localization (Universal Editor)](/merchants/quick-start/content-localization-universal-editor/) for the AEM translation workflow.
