...
This guide shows you how to use the **Document Authoring Tool** (da.live) Translation app to translate your storefront content into multiple languages. After translation, you'll need to complete Commerce-specific tasks for placeholder files and store view verification (see [Commerce localization tasks](/merchants/quick-start/content-localization-commerce-tasks/)).
