...
Use Document Authoring (da.live) to translate your storefront content—including page content, drop-in labels, and UI text—into multiple languages. This guide shows you how to use the da.live Translation app to create localized versions of your storefront without writing code.

<Aside type="tip" title="Choosing your authoring tool">

This guide covers localization workflows for Document Authoring Tool (da.live). If you're using Universal Editor and AEM Cloud Service instead, see [Localization (Universal Editor)](/merchants/quick-start/content-localization-universal-editor/) for the AEM Cloud Service translation workflow.

</Aside>

<Aside type="note" title="What this guide covers">

This guide shows you how to translate content using the da.live Translation app, including:
