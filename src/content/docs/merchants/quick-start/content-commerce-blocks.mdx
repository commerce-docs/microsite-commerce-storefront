...
If you are new to how those tables are structured, read [How block tables work](/merchants/quick-start/block-tables/) first, then return here for the product-level overview.
...
- **Universal Editor**: Edit blocks in-context with immediate live preview
- **Edge Delivery Services**: Ensure fast, reliable delivery of block content globally
- **Digital Assets Management**: Access and manage media assets used within blocks
...
- <Link href={"https://www.aem.live/developer/block-collection"} text={"Block Collection documentation"} />
- <Link href={"https://experienceleague.adobe.com/developer/commerce/storefront/"} text={"Drop-ins documentation"} />
- <Link href={"https://www.aem.live/docs/authoring"} text={"Content blocks tutorial"} />
