...
Alongside the document view, DA.live offers a visual editor for editing a storefront page in context. [Experience Workspace](/merchants/quick-start/experience-workspace/) is the recommended editor for new Document Authoring projects. Enable it directly from a da.live content page using the toggle, or with <Link href="https://da.live/app/adobe-rnd/ew-extensions/tools/ew-setup/ew-setup" text="this tool" />. No boilerplate changes are required.
