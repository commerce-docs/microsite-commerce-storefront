...
<CardGrid>
  <Card icon="puzzle" title="Page Designer">
    Builds and modifies both content blocks and commerce blocks, including a block's styling, spacing, and behavior across devices, and wiring an existing drop-in into a new commerce block. This role requires HTML, CSS, Git, and JavaScript skills, and a working knowledge of Edge Delivery Services component design. A developer steps in for new drop-in packages or changes to a drop-in's own internal behavior. See [Blocks Reference](/boilerplate/blocks-reference/) for the blocks already available to extend, or [Create commerce blocks](/boilerplate/create-commerce-blocks/) to build a new one.
  </Card>
...
If you have the front-end skills to build a new block or layout option, start with [Blocks Reference](/boilerplate/blocks-reference/) to see what already exists, then [Create commerce blocks](/boilerplate/create-commerce-blocks/) to build something new.
