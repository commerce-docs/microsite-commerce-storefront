...
2. [**Experience Workspace**](#experience-workspace): A visual editor that enables business users and content authors to update content directly on the rendered page of the storefront.
...
- **Experience Workspace** provides real-time, in-context editing capabilities for business users and content authors
