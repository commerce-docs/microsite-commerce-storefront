...
Open the document containing your commerce block in the [Document Authoring tool](/merchants/quick-start/document-authoring/) or [Universal Editor](/merchants/quick-start/universal-editor/).
