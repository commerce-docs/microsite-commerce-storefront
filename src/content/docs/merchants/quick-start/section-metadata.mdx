...
- **Block** — The individual commerce functionality (cart, checkout, product details)
  See [Commerce blocks](/merchants/blocks/).
...
Open the document containing your commerce block in the [Document Authoring tool](/merchants/quick-start/document-authoring/) or the [Universal Editor](/merchants/quick-start/universal-editor/).
