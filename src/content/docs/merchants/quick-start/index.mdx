...
Get started by learning what Commerce Storefront is, who builds what, and how block tables work, then open the Document Authoring tool and follow the hands-on tutorial. After that, use the Universal Editor, the blocks overview, and the metadata references as you need them.
...
| [Page Designers and Content Authors](/merchants/quick-start/content-model/) | Why content and presentation are separate, and how the Page Designer and Content Author roles divide the work |
