...
Get started by learning what Commerce Storefront is, who builds what, and how block tables work, then open the Document Authoring tool and follow the hands-on tutorial. After that, use Experience Workspace, the blocks overview, and the metadata references as you need them.
...
| [Building a storefront page](/merchants/quick-start/content-model/) | How content and presentation are separate, and how the Page Designer and Content Author roles divide the work |
...
| [Using Experience Workspace](/merchants/quick-start/experience-workspace/) | Edit storefront content in place, directly on the rendered or live page |
| [Using the Universal Editor](/merchants/quick-start/universal-editor/) | Not the recommended editor for Commerce Storefront; for AEM Sites Authoring projects only |
