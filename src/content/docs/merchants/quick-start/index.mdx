...
Get started by learning what Commerce Storefront is, who builds what, and how block tables work, then open the Document Authoring tool and follow the hands-on tutorial. After that, use Experience Workspace or the Universal Editor, the blocks overview, and the metadata references as you need them.
