...
Experience Workspace is off by default. Enabling it is a one-time task for the whole project, not something each author repeats, and it may require a developer to update your storefront's code before you can turn it on.
...
Open a page in your Document Authoring project in edit view, not the folder view. Once your project is enabled, turn on **New Authoring** in the document editor header to open the current page and every subsequent page in Experience Workspace. To return to the document editor, open your profile menu and turn off **New Authoring**.
