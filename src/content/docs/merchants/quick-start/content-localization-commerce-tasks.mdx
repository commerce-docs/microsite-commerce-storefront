...
After translating your storefront content ([Document Authoring](/merchants/quick-start/content-localization/), or [Universal Editor](/merchants/quick-start/content-localization-universal-editor/) for AEM Sites Authoring projects), complete these Commerce-specific tasks.
