...
What is a slot? A slot is a placeholder in a dropin component where you can add your own UI components and functions. You can use a dropin's built-in slots to add or remove UI components and functions. Or you can add your own additional slots.
