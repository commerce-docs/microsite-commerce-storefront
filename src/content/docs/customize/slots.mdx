...
A slot is a component that provides a place in the UI to swap  where you can add other components, typically UI components. You can use a dropin's built-in slots to add or remove UI components and functions. Or you can add your own additional slots.
