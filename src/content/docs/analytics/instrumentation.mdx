...
:::note
For performance considerations, Adobe highly recommends writing events to the ACDL directly without using the Storefront Events SDK. Drop-ins and widgets will send events to ACDL out of the box, but you should double-check the correctness of all events.
:::
