...
<Aside type="note" title="Already have an Adobe Commerce storefront?">
  ...
  connecting them with [Luma Bridge](/storefront-setup/discovery/luma-bridge/).
</Aside>
