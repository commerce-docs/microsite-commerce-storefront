...
The [Create your storefront tutorial](/get-started/) provides all the information that you need to quickly set up a starter project that uses a pre-configured sample Adobe Commerce backend. After you complete the tutorial, you can [connect](/storefront-setup/configuration/commerce-configuration/) your own Adobe Commerce backend to the project.
