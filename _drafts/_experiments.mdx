...
For example, you can change the color of a button, update the text of a call-to-action, or rearrange the layout of the page. Save the variant page with a new name to distinguish it from the original page.

[placeholder labels](../labeling) or content in the variant page to reflect the changes you want to test.