...
**Lesson 1:** Create a unique product detail page<br/>
...
- Open your project at: `https://da.live/#/adobe-summit-l320/seat-{{YOURSEAT}}`
...
## Lesson 1: Create & Preview a Product Page

### Goal

Build and preview a product page for the iPhone 13.
...
9. **Add Call To Action (CTA) buttton (Optional):**
...
1. **Create a Cart Page Challenger:**
   ...
   - Paste the copy into your `seat-xxx` (root) folder. This creates a challenger document.
...
Placeholder: You have completed the tasks.
