...
The product details page (PDP) drop-in component is a JavaScript module that renders product details on a product details page (PDP) in a storefront. The PDP drop-in component is a collection of functions, components, and utilities that work together to fetch product data from a Commerce backend service and render it on a PDP page.
