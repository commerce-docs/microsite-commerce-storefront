  ...
  return [
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Looking for merchant block reference?', link: '/merchants/blocks/' },
          ],
        },
        {
          label: 'Drop-ins',
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: 'Manual analytics instrumentation',
              collapsed: true,
              items: [
        ...
        // ---------- REFERENCE ----------
        { label: 'Looking for API reference?', link: '/reference/' },
      ],
    },
    ...
    // ========= MERCHANTS =========
    {
      ...
      items: [
        ...
        {
          label: 'Work with Commerce Blocks',
          collapsed: true,
          items: [
            ...
            { label: 'Looking for developer block docs?', link: '/blocks/' },
          ],
        },
        {
          label: 'B2C Blocks',
        ...
        // Note: Account Header and Account Sidebar are shared B2C/B2B blocks listed under B2C Blocks
        {
          label: 'B2B Blocks',
          collapsed: true,
          items: [
