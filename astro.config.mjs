...
async function config() {
  ...
  return defineConfig({
    ...
    redirects: {
      ...
      '/dropins/cart/cart-containers': `${basePath}/dropins/cart/containers/cart-summary-list`,
      ...
      '/get-started/boilerplate-project': `${basePath}/get-started/boilerplate-anatomy`,
              ...
              items: [
                {
                  ...
                  items: [
                    ...
                    {
                      label: 'Boilerplate anatomy',
                      link: '/get-started/boilerplate-anatomy/'
                    },
                    {
                      label: 'Run Lighthouse audits',
                      link: '/get-started/lighthouse-audits/'
                    },
                  ]
                },
                {
