                ...
                items: [
                  ...
                  },
                  {
                    ...
                    items: [
                      ...
                      { label: 'B2B Negotiable Quote', link: '/merchants/blocks/commerce-b2b-negotiable-quote/' },
                      { label: 'B2B Negotiable Quote Template', link: '/merchants/blocks/commerce-b2b-negotiable-quote-template/' },
                      { label: 'B2B Quote Checkout', link: '/merchants/blocks/commerce-b2b-quote-checkout/' },
