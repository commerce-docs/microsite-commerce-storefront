...
async function config() {
  ...
  return defineConfig({
    ...
    redirects: {
      ...
      '/customize/slots': '/dropins/all/extending',
      '/customize/style': '/dropins/all/styling',
      '/customize': '/dropins/all/introduction',
      '/dropins': '/dropins/all/introduction',
      '/dropins/cart/cart-introduction': '/dropins/cart',
      '/dropins/cart/cart-containers': '/dropins/cart/',
      '/dropins/checkout/checkout-introduction': '/dropins/checkout',
      '/dropins/user-account/useraccount-introduction': '/dropins/user-account',
      '/dropins/user-auth/userauth-introduction': '/dropins/user-auth',
      '/faq': '/troublshooting/faq',
      '/get-started/launch-checklist': '/launch',
      '/get-started/requirements': '/setup/discovery/architecture',
      '/get-started/configurations': '/setup/configuration/commerce-configuration',
      '/get-started/storefront-structure': '/get-started/boilerplate-project',
      '/product-details/pdp-containers': '/dropins/product-details/containers',
      '/product-details/pdp-functions': '/dropins/product-details/functions',
      '/product-details/pdp-installation': '/dropins/product-details/installation',
      '/product-details/pdp-introduction': '/dropins/product-details/',
      '/product-details/pdp-slots': '/dropins/product-details/slots',
      '/product-details/pdp-styles': '/dropins/product-details/styles',
      '/references/configurations': '/setup/configuration/commerce-configuration',
      '/references/requirements': '/setup/discovery/architecture',
      '/dropins/cart/cart-installation': '/dropins/cart/installation',
      '/dropins/cart/cart-styles': '/dropins/cart/styles',
      '/dropins/cart/cart-containers': '/dropins/cart/containers',
      '/dropins/cart/cart-slots': '/dropins/cart/slots',
      '/dropins/cart/cart-functions': '/dropins/cart/functions',
      '/dropins/cart/cart-dictionary': '/dropins/cart/dictionary',
      '/dropins/order/order-dictionary': '/dropins/order/dictionary',
      '/config': '/setup/configuration',
      '/config/commerce-configuration': '/setup/configuration/commerce-configuration',
      '/config/content-delivery-network': '/setup/configuration/content-delivery-network',
      '/config/gated-content': '/setup/configuration/gated-content',
      '/config/storefront-compatibility': '/setup/configuration/storefront-compatibility',
      '/get-started/release': '/releases/',
      '/seo/indexing': '/setup/seo/indexing',
      '/seo/metadata': '/setup/seo/metadata',
      '/merchants/multistore': '/merchants/get-started/multistore',
      '/merchants/terms-and-conditions': '/merchants/get-started/terms-and-conditions',
      '/dropins/all/enriching': '/merchants/get-started/enrichment',
      '/dropins/all/experimenting': '/merchants/get-started/experiments',
      '/analytics/instrumentation': '/setup/analytics/instrumentation',
      '/launch': '/setup/launch',
      '/discovery': '/setup',
      '/discovery/architecture': '/setup/discovery/architecture',
      '/discovery/data-export-validation': '/setup/discovery/data-export-validation',
      '/discovery/luma-bridge': '/setup/discovery/luma-bridge',
    },
    integrations: [
      starlight({
        editLink: {
