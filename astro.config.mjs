            ...
            [
              // ========= STORE FRONT DEVELOPERS =========
              {
                ...
                items: [
                  ...
                  {
                    label: 'Boilerplate reference',
                    collapsed: true,
                    items: [
                      { label: 'Overview', link: '/boilerplate/' },
                      { label: 'Project structure', link: '/boilerplate/structure/' },
                      ...
                      { label: 'Configuration', link: '/boilerplate/configuration/' },
                      {
                        ...
                        collapsed: true,
                        items: [
                          { label: 'Commerce Account Header', link: '/boilerplate/blocks/commerce-account-header/' },
                          { label: 'Commerce Account Sidebar', link: '/boilerplate/blocks/commerce-account-sidebar/' },
                          { label: 'Commerce Addresses', link: '/boilerplate/blocks/commerce-addresses/' },
                          { label: 'Commerce Cart', link: '/boilerplate/blocks/commerce-cart/' },
                          { label: 'Commerce Checkout', link: '/boilerplate/blocks/commerce-checkout/' },
                          { label: 'Commerce Confirm Account', link: '/boilerplate/blocks/commerce-confirm-account/' },
                          { label: 'Commerce Create Account', link: '/boilerplate/blocks/commerce-create-account/' },
                          { label: 'Commerce Create Password', link: '/boilerplate/blocks/commerce-create-password/' },
                          { label: 'Commerce Create Return', link: '/boilerplate/blocks/commerce-create-return/' },
                          { label: 'Commerce Customer Details', link: '/boilerplate/blocks/commerce-customer-details/' },
                          { label: 'Commerce Customer Information', link: '/boilerplate/blocks/commerce-customer-information/' },
                          { label: 'Commerce Forgot Password', link: '/boilerplate/blocks/commerce-forgot-password/' },
                          { label: 'Commerce Gift Options', link: '/boilerplate/blocks/commerce-gift-options/' },
                          { label: 'Commerce Login', link: '/boilerplate/blocks/commerce-login/' },
                          { label: 'Commerce Mini Cart', link: '/boilerplate/blocks/commerce-mini-cart/' },
                          { label: 'Commerce Order Cost Summary', link: '/boilerplate/blocks/commerce-order-cost-summary/' },
                          { label: 'Commerce Order Header', link: '/boilerplate/blocks/commerce-order-header/' },
                          { label: 'Commerce Order Product List', link: '/boilerplate/blocks/commerce-order-product-list/' },
                          { label: 'Commerce Order Returns', link: '/boilerplate/blocks/commerce-order-returns/' },
                          { label: 'Commerce Order Status', link: '/boilerplate/blocks/commerce-order-status/' },
                          { label: 'Commerce Orders List', link: '/boilerplate/blocks/commerce-orders-list/' },
                          { label: 'Commerce Return Header', link: '/boilerplate/blocks/commerce-return-header/' },
                          { label: 'Commerce Returns List', link: '/boilerplate/blocks/commerce-returns-list/' },
                          { label: 'Commerce Search Order', link: '/boilerplate/blocks/commerce-search-order/' },
                          { label: 'Commerce Shipping Status', link: '/boilerplate/blocks/commerce-shipping-status/' },
                          { label: 'Commerce Wishlist', link: '/boilerplate/blocks/commerce-wishlist/' },
                          { label: 'Product Details', link: '/boilerplate/blocks/product-details/' },
                          { label: 'Product List Page', link: '/boilerplate/blocks/product-list-page/' },
                          { label: 'Product Recommendations', link: '/boilerplate/blocks/product-recommendations/' },
                        ],
                      },
                    ],
                  },
