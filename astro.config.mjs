...
async function config() {
  ...
  return defineConfig({
    ...
    redirects: {
      ...
      '/discovery/': '/developer/commerce/storefront/setup/discovery/',
      ...
      '/configuration/content-delivery-network/': '/developer/commerce/storefront/setup/configuration/content-delivery-network/',
      '/configuration/gated-content/': '/developer/commerce/storefront/setup/configuration/gated-content/',
      '/configuration/storefront-compatibility/': '/developer/commerce/storefront/setup/configuration/storefront-compatibility/',
