...
consider adding some more robust docs for the Actions slot, and any other ones we anticipate to be used often.
    ...
    ```yaml del={"Replace the default SharePoint URL":1} ins={"With your Google Drive folder URL":4} del="https://adobe.sharepoint.com/:f:/r/sites/HelixProjects/Shared%20Documents/sites/starter-content-commerce" ins="https://drive.google.com/drive/u/0/folders/12PtetIm9hMFX7P5PwtH4AvNISNyRjre7"
    //
    mountpoints:
      /: https://adobe.sharepoint.com/:f:/r/sites/HelixProjects/Shared%20Documents/sites/starter-content-commerce

    https://drive.google.com/drive/u/0/folders/12PtetIm9hMFX7P5PwtH4AvNISNyRjre7
    ```
